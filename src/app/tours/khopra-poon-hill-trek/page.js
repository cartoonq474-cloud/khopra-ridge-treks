    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen font-sans antialiased flex flex-col justify-between">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-900 via-stone-800 to-emerald-950 text-white py-24 px-6 border-b border-stone-800">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/35 px-4 py-1 text-xs font-bold text-emerald-400 uppercase tracking-widest mb-6">Premier Trekking Combination Loop
          </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12 w-full flex-1">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#why-combine" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Why Choose This Combo?
              </a>
              <a href="#suitability" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Is This Trek Right for You?
              </a>
              <a href="#route-overview" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Route Map Overview
              </a>
              ...
              <a href="#difficulty" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Trek Difficulty &amp; Steps
              </a>
              ...
              <a href="#accommodation" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Teahouse vs Lodging
              </a>
              <a href="#cost" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Cost &amp; Budget Guide
              </a>
              <a href="#packing" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">What to Pack
              </a>
              <a href="#scenic" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Mountain Highlights
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-base">The Khopra Ridge &amp; Poon Hill Combination Trek brings together two of the Annapurna region&apos;s most rewarding trekking experiences into one seamless, 10-day Himalayan adventure.
            </p>
            ...
            <p className="text-stone-600 leading-relaxed text-base">Where Poon Hill is accessible and well-known, Khopra Ridge (3,660m) is quieter, wilder, and genuinely off the beaten path. The trail beyond Ghorepani leads through rhododendron forests, open meadows, and remote village settlements until the ridge opens up into one of the most complete Himalayan panoramas you will find anywhere in the Annapurna region.
            </p>
            <p className="text-stone-600 leading-relaxed text-base">Together, these two destinations create a trek that offers the best of both worlds: the classic Nepal trekking experience and something far more personal, authentic, and memorable.
            </p>
            ...
            <div className="bg-white border border-stone-200 rounded-3xl p-6 mt-8 shadow-sm">
              <h3 className="text-lg font-bold text-stone-950 mb-4 flex items-center gap-2">Trek Highlights at a Glance
              </h3>
          ...
          <article id="suitability" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Is This Trek Right for You?
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Before committing to any trek, it helps to know honestly whether it matches your fitness level, travel style, and goals. Here is a practical breakdown.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl">
                <h4 className="font-bold text-stone-950 text-base">First-Time Trekkers</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">Well-suited to first-time trekkers who want a genuine mountain experience without the extreme altitude or technical demands of routes like ABC or the Everest region. The trails are established, lodges are comfortable, and the scenery rewards every hour.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl">
                <h4 className="font-bold text-stone-950 text-base">Photographers &amp; Nature Lovers</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">The combination of Poon Hill sunrise, blooming rhododendron forests, and sustained ridge viewpoints makes this one of the strongest visual itineraries in Nepal. Morning light on the Annapurna South face is extraordinary.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl">
                <h4 className="font-bold text-stone-950 text-base">Solitude Seekers</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">If you have looked at the Poon Hill short circuit and thought it might feel too busy, this route gives you what you are looking for. The trail beyond Tadapani sees dramatically fewer trekkers, and the community lodge circuit has a quiet, exploratory atmosphere.
                </p>
              </div>
            </div>
          ...
          <article id="route-overview" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Khopra Ridge &amp; Poon Hill Trek Route Overview
            </h2>
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Pokhara to Nayapul and the Annapurna Trailhead</h4>
                  <p className="text-xs text-stone-500 leading-relaxed mt-1">The trek begins with a drive from Pokhara to Nayapul, taking 1.5 to 2 hours by road. Nayapul sits at the meeting point of Modi Khola and Bhurungdi Khola. From here, the trail climbs steadily through Birethanti toward Tikhedhunga and Ghorepani.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Ghorepani and the Poon Hill Sunrise</h4>
                  <p className="text-xs text-stone-500 leading-relaxed mt-1">Ghorepani (2,860m) is the staging point for the pre-dawn climb to Poon Hill (3,210m). The climb takes 45 minutes to one hour, offering sunset-like orange and red reflections on Annapurna South, Dhaulagiri I, Hiunchuli, Nilgiri, and Machhapuchhre.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Tadapani and Forest Trails</h4>
                  <p className="text-xs text-stone-500 leading-relaxed mt-1">After Poon Hill, the trail heads east to Tadapani (2,630m), crossing one of the finest rhododendron forests in the Annapurna Conservation Area.
                  </p>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-stone-500 leading-relaxed mt-1">From Tadapani, the trail climbs toward Bayeli Kharka and Chistibung — two small settlements marking the transition from the forest zone into high-altitude terrain. The landscape becomes remote and the sense of exploration increases.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Reaching Khopra Ridge</h4>
                  <p className="text-xs text-stone-500 leading-relaxed mt-1">Khopra Ridge (Khopra Danda) sits at 3,660m. The community lodge is well-run, and trekkers typically spend two nights here — one for rest/acclimatization and one for the optional Khayer Lake excursion.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Optional Route to Khayer Lake</h4>
                  <p className="text-xs text-stone-500 leading-relaxed mt-1">From Khopra Ridge, a demanding day hike climbs to Khayer Lake (4,660m). The trail is steep and exposed, and the additional altitude should not be underestimated. Recommended for well-acclimatised trekkers.
                  </p>
                </div>
              </div>
            </div>
          ...
          <article id="itinerary" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Detailed 10-Day Khopra Ridge and Poon Hill Trek Itinerary
            </h2>
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-3xl p-6 mt-8">
              <h3 className="text-lg font-bold text-emerald-950 mb-3">Optional Khayer Lake Extension</h3>
              <p className="text-xs text-stone-600 leading-relaxed">Khayer Lake deserves more than a footnote in any Khopra Ridge itinerary. It is a genuinely significant destination in its own right, and for many trekkers who include it, the lake becomes the defining memory of the entire journey.
              </p>
          ...
          <article id="difficulty" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">How Difficult Is the Khopra Ridge Trek?
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">The Khopra Ridge &amp; Poon Hill Combination Trek is rated moderate overall, but it is worth understanding what that means in practice.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Daily Walking Hours</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">On most days, you will walk between 3 and 6 hours. The longest days — typically the climb to Ghorepani and the descent from Khopra Ridge — approach 6 hours of actual trekking time. Rest stops, photography, and teahouse breaks typically add 1 to 2 additional hours to each day&apos;s schedule.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
          ...
          <article id="best-time" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Best Time for the Khopra Ridge &amp; Poon Hill Trek
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Warming temperatures, excellent trail conditions, and rhododendron forests in full bloom. March and April are the strongest months for reliable weather and clear views.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Best season for mountain visibility. Post-monsoon air is washed clear, producing blue skies. October delivers the clearest views. Nights are colder, falling below freezing on the ridge.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Possible but demanding. Snow can affect higher trail sections, and upper lodges may be closed. Offers incredible solitude and crisp, clear days for well-equipped winter hikers.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Heavy rain, mud, and leeches in forests. Cloud cover regularly obscures mountains. Not recommended, except for the pilgrimage festival in August.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="permits" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Permits Required for the Trek
            </h2>
            <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-4">
              ...
              <p className="text-xs text-stone-500 leading-relaxed">As of recent updates, the TIMS card requirement has been integrated into a single permit registry system. Permits can be obtained at the Nepal Tourism Board office in Kathmandu or Pokhara Damside. Processing is straightforward (bring your passport and photos).
              </p>
            </div>
          </article>
          ...
          <article id="accommodation" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Accommodation and Food on the Trail
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">The Khopra Ridge &amp; Poon Hill Combination Trek is a fully supported teahouse and community lodge trek. No camping is required, and accommodation is available every night of the itinerary.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                ...
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">The standard menu features dal bhat (rice, lentil soup, curry), noodles, fried rice, porridge, eggs, and pancakes. Prices increase slightly at higher altitudes. Carry purification tablets or filters to treat tap water, reducing plastic waste and saving cost on bottled water.
                </p>
              </div>
            </div>
            ...
            <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6 mt-6">
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">Charging facilities are available at most teahouses on the lower route for a small fee (NPR 100–200). Community lodges higher up may have solar-powered charging but this is not guaranteed; a power bank is highly useful. Wi-Fi becomes unreliable or absent beyond Tadapani. Mobile signal (NTC/Ncell) is patchy at Khopra Ridge elevation.
              </p>
            </div>
          </article>
          ...
          <article id="cost" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Khopra Ridge &amp; Poon Hill Trek Cost Guide
            </h2>
            ...
            <div className="bg-white border border-stone-200 rounded-3xl p-6 shadow-sm">
              ...
              <p className="text-xs text-stone-500 mt-4 text-center">For a 10-day independent trek, budget approximately <strong>USD 300–500 total</strong>.
              </p>
            </div>
          ...
          <article id="packing" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">What to Pack for the Trek
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Packing well means the difference between a comfortable trek and an uncomfortable one. Here is what to bring.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl">
                <h4 className="font-bold text-stone-900 text-sm uppercase tracking-wide border-b border-stone-100 pb-2 mb-3">Clothing</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Moisture-wicking base layers (2 sets), fleece mid-layer, down jacket, waterproof/windproof outer shell, trekking trousers (non-cotton), warm hat, gloves, buff, sun hat, and camp shoes for evenings.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">Sturdy trekking boots (broken in!), trekking poles, 20–30L daypack for essentials, sleeping bag liner (warm bag recommended for shoulder seasons), headlamp (essential for Poon Hill dawn), and power bank.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">First-aid kit, Diamox (consult your doctor), water purification tablets, high-SPF sunscreen, lip balm, rehydration salts, and blister treatment kit.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="scenic" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Mountain Views and Scenic Highlights
            </h2>
            <div className="space-y-6 text-stone-600 text-sm leading-relaxed">
              <div>
                <h4 className="font-bold text-stone-900 text-base">Annapurna South (7,219m)</h4>
                <p className="mt-1">Dominates the view from both Poon Hill and Khopra Ridge. From the ridge, it feels close enough to study the details of its southern face — the seracs, ridgelines, and glaciers visible in outstanding clarity.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-stone-900 text-base">Dhaulagiri (8,167m)</h4>
                <p className="mt-1">The world&apos;s seventh-highest mountain stands dramatically to the west. From Khopra Ridge, the views of Dhaulagiri&apos;s enormous pyramid face are unobstructed and humbling.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-stone-900 text-base">Nilgiri (7,061m) &amp; Machhapuchhre (6,993m)</h4>
                <p className="mt-1">Nilgiri rises to the north as a wall of ice. Machhapuchhre (Fishtail) stands with its twin-summit pyramid profile anchoring the eastern end of the mountain panorama throughout the route.
                </p>
              </div>
            </div>
          ...
          <article id="faq" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Frequently Asked Questions About the Khopra Ridge &amp; Poon Hill Trek
            </h2>
          ...
          <article className="space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-sm">The Khopra Ridge &amp; Poon Hill Combination Trek offers what few trekking itineraries can genuinely deliver: two distinct, world-class experiences in a single journey, connected by trails that become quieter and more rewarding with every day.
            </p>
            <p className="text-stone-600 leading-relaxed text-sm">You begin with one of Nepal&apos;s most famous mornings — the Poon Hill sunrise, the full Annapurna panorama, the feeling of being exactly where you imagined Nepal would look like. Then you continue into something rarer — the community lodge circuit, the open ridge, the mountains seen not as a backdrop but as a surrounding presence, and an optional extension to a sacred glacial lake that most Nepal visitors never find.
            </p>
            <p className="text-stone-600 leading-relaxed text-sm">This route combines the familiar and the unknown, the iconic and the undiscovered, in a proportion that feels exactly right for 10 days of trekking in the Himalayas.
            </p>
          </article>
