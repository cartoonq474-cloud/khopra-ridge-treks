      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Combine the classic, iconic sunrise viewpoint of Poon Hill (3,210m) with the quiet, panoramic wilderness of Khopra Ridge (3,660m) in one single, spectacular itinerary.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 rounded-2xl border border-stone-200 bg-white p-6 sm:grid-cols-4">
            ...
            <p className="mt-1 text-sm font-bold text-stone-900">10 Days</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Max Elevation</span>
            <p className="mt-1 text-sm font-bold text-stone-900">3,660 m (4,660 m optional Khayer Lake)</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Difficulty</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Moderate</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Start/End</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Pokhara / Pokhara</p>
          </div>
