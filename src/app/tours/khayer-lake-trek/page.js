      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">
            Sacred Khayer Lake Pilgrimage Trek
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Journey to the holy alpine waters of Khayer Lake, situated at 4,660m directly beneath the towering south face of Annapurna. A sacred site for both Hindu and Buddhist pilgrims.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 rounded-2xl border border-stone-200 bg-white p-6 sm:grid-cols-4">
            ...
            <p className="mt-1 text-sm font-bold text-stone-900">9 Days</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Max Elevation</span>
            <p className="mt-1 text-sm font-bold text-stone-900">4,660 m</p>
          </div>
          <div>
