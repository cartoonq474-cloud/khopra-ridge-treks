      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Trek through the two best community-owned ridges in the Annapurna region. Support local village development while enjoying direct views of Dhaulagiri and the Annapurna range.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 rounded-2xl border border-stone-200 bg-white p-6 sm:grid-cols-4">
            ...
            <p className="mt-1 text-sm font-bold text-stone-900">11 Days</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Max Elevation</span>
            <p className="mt-1 text-sm font-bold text-stone-900">3,660 m</p>
          </div>
          <div>
          ...
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Accommodation</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Community Lodges & Homestays</p>
          </div>
