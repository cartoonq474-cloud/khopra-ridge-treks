    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khopra Ridge vs. Mohare Danda Trek
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Compare two community-based, low-crowd trekking circuits in the Annapurna to choose your perfect community eco-trail.
          </p>
        </div>
        ...
        <div className="mt-16 space-y-8">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-white border border-stone-200 rounded-3xl space-y-2 shadow-sm">
              ...
              <p className="text-xs text-stone-500 leading-relaxed">Mohare Danda reaches a maximum elevation of 3,300m, presenting virtually no risk of Acute Mountain Sickness (AMS). It is an ideal warm-up trek. Khopra Ridge goes up to 3,660m, with a steep day climb to Khayer Lake at 4,660m, requiring proper acclimatization and hydration.
              </p>
            </div>
            
            <div className="p-6 bg-white border border-stone-200 rounded-3xl space-y-2 shadow-sm">
              <h4 className="font-extrabold text-stone-950 text-base">2. Trail Scenery &amp; Vistas</h4>
              <p className="text-xs text-stone-500 leading-relaxed">Mohare Danda runs parallel to Poon Hill, offering a similar wide landscape panorama from its summit ridge. Khopra Ridge brings you much closer to the Dhaulagiri massifs and puts you right on the edge of the deep Kali Gandaki valley.
              </p>
            </div>

            <div className="p-6 bg-white border border-stone-200 rounded-3xl space-y-2 shadow-sm">
              <h4 className="font-extrabold text-stone-950 text-base">3. Trip Pacing &amp; Group Profile</h4>
              <p className="text-xs text-stone-500 leading-relaxed">Mohare Danda is perfect for families, beginners, and senior trekkers who prefer short daily stages (3-4 hours) and comfortable homestays. Khopra Ridge is best suited for fit hikers who enjoy strenuous climbs and high-altitude challenges.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">We operate community tours on both trails. This comparison is maintained in cooperation with the local village tourism networks of Swanta and Nangi.
            </p>
          </div>
        </div>
...
export const metadata = {
  alternates: {
    canonical: '/guides/khopra-vs-mohare-danda',
  },
};
