    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Best Short Trek in Nepal: Annapurna Alternatives
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Short on calendar days? Compare the best short-duration trekking packages (3 to 6 days) in the Annapurna range to pick the perfect route.
          </p>
        </div>
            ...
            {shortTreks.map((trek, idx) => (
              <div key={idx} className="p-6 bg-white border border-stone-200 rounded-3xl shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-stone-100 pb-3 gap-2">
                  ...
                  <span className="text-xs font-bold text-emerald-600 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 shrink-0">Max Alt: {trek.elev}
                  </span>
                </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">We compile feedback from over 500 short-trek departures annually. All routes are mapped for optimal pacing and acclimatization safety.
            </p>
          </div>
        </div>
