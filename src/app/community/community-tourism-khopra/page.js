    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Community Tourism on the Khopra Ridge Trek
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Learn about the community lodge model, how it differs from standard tourism, and how your trek directly funds mountain schools and clinics.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">The Khopra Ridge Trek is unique because it operates on a community-based cooperative tourism model. Instead of private hotel owners keeping all profits or sending them back to Kathmandu, the lodges at Swanta, Chhistibung, Bayeli, Dobato, and Khopra Ridge are collectively owned and operated by local villagers.
          </p>
          <p className="text-stone-600 leading-relaxed">Pioneered by local community developer and Magsaysay award winner Mahabir Pun, this project was designed to combat rural depopulation. By building lodges with communal effort and sourcing all labor and food locally, the communities have created a sustainable economy that funds critical social services.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">We cooperate directly with Nangi and Swanta village development committees. We track donation records and lodge audits to verify transparency in community allocations.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">Support the cooperative by booking our 9-Day all-inclusive packages. We prioritize village-run lodges and local Magar/Gurung trail staff.
            </p>
...
export const metadata = {
  alternates: {
    canonical: '/community/community-tourism-khopra',
  },
};
