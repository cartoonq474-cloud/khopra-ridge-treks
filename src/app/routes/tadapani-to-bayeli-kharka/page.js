    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Tadapani to Bayeli Kharka Route Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Discover the quiet wilderness trail. Read our guide covering segment distance, deep forest ascents, alpine meadows, and the community lodge at Bayeli Kharka.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">The trek from Tadapani (2,630m) to Bayeli Kharka (3,425m) leaves the main commercialized Annapurna trails behind. You immediately enter a deep forest trail filled with ancient oaks, rhododendrons, and bamboo. The trail is far quieter, with only a fraction of the hikers found on the Poon Hill circuit.
          </p>
          <p className="text-stone-600 leading-relaxed">As you climb steadily, you pass several mossy streams and small pasture clearings used by local herders. The final segment ascends out of the dense forest into the sub-alpine meadow of Bayeli Kharka. Here, the west face of Annapurna South rises directly above you, offering an intimate mountain viewing experience.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">Our guides walk the Tadapani-Bayeli forest trail monthly to monitor trail degradation, mudslide boundaries, and guest house sanitation standards.
            </p>
          </div>
        </div>
