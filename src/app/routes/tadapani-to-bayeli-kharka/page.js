...
export const metadata = {
  title: "Tadapani to Bayeli Kharka Route Guide | Khopra Ridge Trek",
  description: "Planning the Tadapani to Bayeli Kharka trek? We cover distance, hiking time, elevation gain, trail conditions, navigation, and accommodation on this quiet.",
  alternates: {
