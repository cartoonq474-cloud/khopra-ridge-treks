    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khopra Ridge to Sacred Khayer Lake Route Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Trek to the sacred pilgrimage site. Read our guide covering segment distance, technical ridge flanks, altitude sickness prevention, and the Khayer Baraha Temple.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">The day hike from Khopra Ridge (3,660m) to Sacred Khayer Lake (4,660m) is a challenging alpine journey. This is a full-day round-trip excursion that takes you along the rugged, exposed flanks of the mountain range under the towering west face of Annapurna South.
          </p>
          <p className="text-stone-600 leading-relaxed">The path starts early in the morning and winds upwards across rocky slopes and scree fields. High altitude makes this trek demanding, and packing warm layers, windbreakers, and plenty of snacks is crucial. Upon arrival, you will find the serene, sacred lake against the dramatic snow walls, along with the shrine of Khayer Baraha where Hindu pilgrims gather during the August festival.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">Our guides walk the Khopra-Khayer Lake trail monthly to monitor trail degradation, mudslide boundaries, and guest house sanitation standards.
            </p>
          </div>
        </div>
