      ...
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">
            Swanta Village to Ghorepani Route Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Rejoin the classic route loop. Read our guide covering segment distance, the river suspension bridge, steady stone staircases, and Ghorepani node lodges.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">
            The hike from Swanta Village (2,200m) to Ghorepani (2,860m) connects the offbeat community trail back to the classic Annapurna Circuit loop. The day begins with a short descent through village fields down to cross a suspension bridge over the river.
          </p>
          <p className="text-stone-600 leading-relaxed">
            After crossing the river, the trail starts a steady climb back up the valley wall. You will ascend along stone staircases through beautiful rhododendron forests. As you approach Ghorepani, you will notice a transition back to private teahouses and expanded tourist amenities, preparing you for tomorrow&apos;s early sunrise hike.
          </p>
        </div>
