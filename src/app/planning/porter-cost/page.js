    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Porter Cost &amp; Weight Limits
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Understand the expenses of hiring a local porter. Review wage scales, maximum weight limitations, ethical guidelines, and tipping standards.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Hiring a local porter costs **$20 to $25 USD per day**. This covers their daily wage, food and lodging along the trail, and essential mountain medical insurance. Sharing a porter between two hikers is standard, with each hiker placing up to 7.5kg to 9kg of gear inside a shared duffel bag.
          </p>
          <p>We strictly enforce IPPG (International Porter Protection Group) guidelines. We ensure our porters are provided with warm windproof clothing, proper hiking boots, standard sleeping space, and carry no more than the legal limit of 18kg.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Enjoy a comfortable, weight-free hike. Book our guided packages which include pre-arranged, ethical porter support.
            </p>
            <Link
              href="/#book"
