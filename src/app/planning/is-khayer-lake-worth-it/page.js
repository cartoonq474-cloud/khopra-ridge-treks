    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Is Khayer Lake Worth It? Effort vs. Reward
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">An honest, guide-backed evaluation. Learn why this demanding 10-hour day hike is the ultimate highlight for some, but a step too far for others.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Reaching Khayer Lake (4,660m / 15,288ft) requires hiking 16 kilometers round-trip, climbing 1,000 meters vertically over rough moraine trails, and walking for 8 to 10 hours at high altitude. There are no tea houses, toilets, or snack shops along the way.
          </p>
          <p>This brings up an important question for many trekkers: **Is the physical toll of climbing to Khayer Lake worth the visual reward?**
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>If you decide to skip the lake hike, you can still have a highly rewarding rest day:
          </p>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Not sure if you have the conditioning for the lake? Our guides evaluate your fitness during the first days of the trek to help you make a safe, informed decision.
            </p>
            <Link
              href="/#book"
