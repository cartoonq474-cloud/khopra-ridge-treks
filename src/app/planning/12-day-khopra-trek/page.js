    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">The ultimate community lodge and eco-tourism circuit. Combine the Mohare Danda homestays, Ghorepani Poon Hill, and the high Khopra Ridge into a single, comprehensive adventure.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Experience the best of homestay hospitality and high altitude wilderness. Book our 12-day guided package today.
            </p>
            <Link
              href="/#book"
