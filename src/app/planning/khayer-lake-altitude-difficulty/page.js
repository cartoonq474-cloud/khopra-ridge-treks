    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen font-sans antialiased flex flex-col justify-between">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white py-24 px-6 border-b border-stone-800">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/35 px-4 py-1 text-xs font-bold text-emerald-400 uppercase tracking-widest mb-6">Altitude &amp; Safety Guide
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight max-w-5xl">Khayer Lake Altitude &amp; Difficulty Guide
          </h1>
          <p className="mt-6 text-base md:text-lg lg:text-xl text-stone-300 max-w-4xl leading-relaxed font-medium">At 4,660 meters, this sacred alpine lake sits in genuinely thin air. Learn why the trek to reach it is shaped almost entirely by how your body handles altitude, and how to safely prepare for the physical challenges.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12 w-full flex-1">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              <a href="#overview" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Quick Answer &amp; Overview
              </a>
              <a href="#altitude-facts" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">What Is the Altitude?
              </a>
              <a href="#calculator" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Oxygen Pressure Calculator
              </a>
              <a href="#trek-difficulty" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Overall Difficulty
              </a>
              <a href="#distance-stats" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Distance &amp; Statistics
              </a>
              <a href="#day-hike-challenge" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Why the Hike Feels Harder
              </a>
              <a href="#trail-terrain" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Trail Terrain Conditions
              </a>
              <a href="#ams-risks" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Altitude Sickness (AMS) Risk
              </a>
              <a href="#acclimatization" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Acclimatization Plan
              </a>
              <a href="#route-difficulty" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Route Elevation Options
              </a>
              <a href="#fitness-prep" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Fitness &amp; Preparation
              </a>
              <a href="#best-time" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Best Seasons &amp; Climate
              </a>
              ...
              <a href="#safety-tips" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Essential Safety Tips
              </a>
              <a href="#is-it-for-you" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Is it Right for You?
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-3">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">The risk rises sharply as you cross 4,000m on the final approach to the lake. Pacing, hydration, and gradual climbs are critical.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-3">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">Achievable for fit beginners who build in a rest day at Khopra Ridge (3,660m) rather than rushing the climb.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="altitude-facts" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-955 tracking-tight border-b border-stone-200 pb-3">What Is the Altitude of Khayer Lake?
            </h2>
            <div className="space-y-4 text-stone-600 text-sm leading-relaxed">
              <h3 className="text-lg font-bold text-stone-950">Khayer Lake Elevation in Meters and Feet</h3>
              <p>Khayer Lake sits at <strong>4,660 meters (15,289 feet)</strong>above sea level. That places it firmly in what mountaineers call the high-altitude zone, the range where oxygen availability drops enough to noticeably affect breathing, energy, and sleep quality even in healthy adults.
              </p>
              <p>Crossing 4,500 meters is a meaningful threshold. Below that line, most trekkers with reasonable fitness adjust within a day or two. Above it, the body has to work measurably harder for the same effort, which is why this single elevation figure shapes almost every other decision on this trek.
              </p>

              <h3 className="text-lg font-bold text-stone-955 mt-6">Highest Point of the Khayer Lake Trek</h3>
              <p>Khayer Lake itself is the highest point most trekkers reach on this route. There is no higher pass or ridge beyond it on the standard itinerary, so 4,660m represents the trek&apos;s true ceiling rather than a midpoint on the way to somewhere higher. This simplifies your acclimatization strategy: you are not pacing yourself for a bigger climb later — the lake is the destination and the turnaround point.
              </p>

              <h3 className="text-lg font-bold text-stone-955 mt-6">Khopra Ridge vs Khayer Lake Altitude</h3>
              <p>Most itineraries base trekkers at Khopra Ridge (also called Khopra Danda), at 3,660m (12,008ft), and treat Khayer Lake as a day hike from there. That gap — <strong>exactly 1,000 meters</strong> — is the most important number to keep in mind.
              </p>
              <p>Sleeping at 3,660m while day-hiking up to 4,660m and returning the same evening follows one of the most reliable altitude safety principles in mountaineering. You gain exposure to thinner air during the day, but you sleep at a lower, more oxygen-rich elevation, which gives your body a real chance to recover overnight.
              </p>
            </div>
          </article>
          ...
          <article id="calculator" className="scroll-mt-12 space-y-6">
            <div className="p-8 bg-white border border-stone-200 rounded-3xl shadow-sm space-y-6">
              ...
              <p className="text-stone-600 text-sm leading-relaxed">As you ascend, the barometric pressure drops, resulting in fewer oxygen molecules per breath. Use the slider below to estimate the effective oxygen level relative to sea level.
              </p>
          ...
          <article id="trek-difficulty" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-955 tracking-tight border-b border-stone-200 pb-3">How Difficult Is the Khayer Lake Trek?
            </h2>
            <p className="text-stone-600 text-sm leading-relaxed">Overall, the Khayer Lake trek rates as <strong>moderate to moderately challenging</strong>. It doesn&apos;t require technical mountaineering skills, ropes, or prior high-altitude experience, but it does demand solid cardiovascular fitness, multiple consecutive days of hiking, and genuine respect for altitude.
            </p>
            ...
            <div className="space-y-4 text-stone-650 text-sm">
              ...
              <p>The physical load comes from three things stacking on top of each other: multi-hour daily walking, steep elevation gain on certain days, and several consecutive trekking days with limited full rest. The single hardest day is the Khayer Lake round trip itself, which involves a steep, sustained climb followed by a long descent back to Khopra Ridge — all in thinner air than your body is used to.
              </p>

              <h3 className="text-lg font-bold text-stone-900">Why Altitude Is the Biggest Challenge</h3>
              <p>Distance and terrain are manageable for most regular hikers; altitude is the variable that changes everything. Above roughly 3,000 meters, the air contains noticeably less oxygen per breath, and your body has to compensate by breathing faster and working your heart harder. Fitness alone doesn&apos;t guarantee an easy time above 4,000 meters — genetics, hydration, sleep quality, and ascent pace play massive roles.
              </p>
          ...
          <article id="distance-stats" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Khayer Lake Trek Distance, Duration, and Elevation Gain
            </h2>
            <div className="space-y-4 text-stone-600 text-sm leading-relaxed">
              ...
              <p>Daily walking hours range from 5–7 hours, with the Khayer Lake day stretching to <strong>7–9 hours round trip</strong>once you factor in the steep terrain and slower pace at altitude.
              </p>
              <p>From Ghandruk (around 1,940m) to Khayer Lake at 4,660m, you are gaining roughly <strong>2,700 meters of net elevation</strong>over several days, with the final 1,000-meter push from Khopra Ridge to the lake concentrated into a single demanding day.
              </p>
            </div>
          ...
          <article id="day-hike-challenge" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Why the Khayer Lake Day Hike Feels Harder Than Expected
            </h2>
            <div className="grid gap-6 md:grid-cols-3">
              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-sm">Relentless Steepness</h4>
                <p className="text-[11px] text-stone-500 leading-relaxed font-medium">The trail above Khopra Ridge climbs steadily and steeply toward Khayer Lake, with little flat ground to recover on. Pacing yourself on earlier, gentler days is key.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm">Thin Air &amp; Breathing</h4>
                <p className="text-[11px] text-stone-500 leading-relaxed font-medium">Once you cross 4,000 meters, the reduced oxygen becomes impossible to ignore. Short uphill bursts require deliberate pacing and breathing.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm">Long Return Journey</h4>
                <p className="text-[11px] text-stone-500 leading-relaxed font-medium">Because it is treated as a single day hike, you must descend the same 1,000 meters back to Khopra Ridge afterward on tired legs.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="trail-terrain" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Trail Conditions and Terrain on the Route
            </h2>
            <div className="space-y-4 text-stone-600 text-sm leading-relaxed">
              <p>The route starts in <strong>dense forest trails</strong> (Ghandruk to Tadapani) of rhododendron and oak, which are gentler and well-shaded. As you climb, the trail opens up into <strong>exposed ridge walking</strong>around Khopra Ridge, where weather and wind have a much bigger effect.
              </p>
              <p>Much of the route alternates between <strong>stone steps, rocky paths, and shared mule trails</strong>. The constant up-and-down on uneven stone steps is hard on the knees and requires slow pacing.
              </p>
              <p>The final approach to the lake moves into true <strong>alpine terrain</strong> — sparse vegetation, rocky ground, scree, and exposure to wind and cold even on clear days.
              </p>
            </div>
          </article>
          ...
          <article id="ams-risks" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-955 tracking-tight border-b border-stone-200 pb-3">Altitude Sickness Risk on the Khayer Lake Trek
            </h2>
            <div className="space-y-4 text-stone-600 text-sm leading-relaxed">
              <h3 className="text-lg font-bold text-stone-950">At What Altitude Does AMS Become a Concern?</h3>
              <p>Acute Mountain Sickness (AMS) risk typically begins to rise above 2,500–3,000 meters, which corresponds roughly to the Tadapani-to-Bayeli Kharka stretch. By the time you reach Khopra Ridge at 3,660m, mild symptoms are common, and the push to Khayer Lake at 4,660m is where risk is highest.
              </p>
              ...
              <div className="bg-red-50 border border-red-200 p-5 rounded-2xl text-red-950 text-xs leading-relaxed font-semibold">Critical Safety Warning: Severe AMS symptoms (confusion, loss of coordination, a persistent dry cough, shortness of breath at rest, or a worsening headache that doesn&apos;t respond to rest/hydration) demand immediate descent. These symptoms should never be pushed through.
              </div>

              <h3 className="text-lg font-bold text-stone-950">How Common Is Altitude Sickness at Khayer Lake?</h3>
              <p>Mild AMS symptoms — headache, slight fatigue — are common at this altitude and affect a meaningful share of trekkers, even fit ones. Severe AMS is far less common, especially for trekkers who follow a sensible acclimatization schedule and don&apos;t rush the final ascent.
              </p>
            </div>
          </article>
          ...
          <article id="acclimatization" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Acclimatization Strategy for Reaching Khayer Lake Safely
            </h2>
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-sm sm:text-base">Staying at Khopra Ridge Helps</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Basing yourself at Khopra Ridge (3,660m) for the Khayer Lake push, rather than trying to reach the lake and a higher overnight stop in one go, gives your body a lower, more breathable elevation to recover at after the day&apos;s exertion.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm sm:text-base">Climb High, Sleep Low</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Exposing your body to higher elevation during the day stimulates the physiological adaptations that help you acclimatize, while sleeping at a lower elevation afterward lets your body recover without the added stress of overnight oxygen deprivation.
                </p>
              </div>
            </div>
          ...
          <article id="route-difficulty" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Difficulty by Route Option
            </h2>
            <div className="space-y-4 text-stone-600 text-sm">
              <div className="p-5 bg-white border border-stone-200 rounded-2xl space-y-2">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">Starting from Ghandruk is the most common approach and gives you the most gradual acclimatization profile, since you pass through Tadapani and Bayeli Kharka before reaching Khopra Ridge. This route spreads the elevation gain over more days, which makes it the gentlest option for trekkers without prior high-altitude experience.
                </p>
              </div>
              <div className="p-5 bg-white border border-stone-200 rounded-2xl space-y-2">
                <h4 className="font-bold text-stone-900"> 2. Khayer Lake Trek from Tadapani</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Starting or rejoining the route at Tadapani shortens the trek by a day but compresses the elevation gain that follows. It suits trekkers who already have some altitude experience or limited time, but it leaves less buffer for acclimatization than the full Ghandruk start.
                </p>
              </div>
              <div className="p-5 bg-white border border-stone-200 rounded-2xl space-y-2">
                <h4 className="font-bold text-stone-900"> 3. Khayer Lake Trek from Khopra Ridge</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Once you&apos;re based at Khopra Ridge, the push to Khayer Lake is a single demanding day hike — steep, exposed, and the most physically intense day of the entire trek regardless of which route brought you there. This is the section every itinerary variation eventually funnels into.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="best-time" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Best Time for the Khayer Lake Trek
            </h2>
            <div className="space-y-4 text-stone-600 text-sm">
              <p>
          ...
          <article id="comparisons" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Khayer Lake Difficulty Compared to Other Popular Nepal Treks
            </h2>
            <div className="space-y-4 text-stone-600 text-sm">
          ...
          <article id="safety-tips" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Essential Safety Tips for Trekking to Khayer Lake
            </h2>
            <div className="grid gap-6 md:grid-cols-2 text-stone-600 text-sm">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                ...
                <p className="text-xs text-stone-500 leading-relaxed font-medium">Slow your walking pace noticeably once you pass 3,000 meters. A slower, steady rhythm reduces strain on your cardiovascular system and lowers your AMS risk.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm">Monitor Daily Saturation</h4>
                <p className="text-xs text-stone-500 leading-relaxed font-medium">Check in with yourself and a pulse oximeter morning and evening. Catching a mild headache or dropping oxygen saturation early gives you options before symptoms become severe.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm">Prepare for Weather Swings</h4>
                <p className="text-xs text-stone-500 leading-relaxed font-medium">Conditions near Khopra Ridge and Khayer Lake can shift quickly, even in favorable seasons. Carry layers, a windproof shell, and don&apos;t assume a clear morning guarantees a clear afternoon.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm">Know When to Turn Back</h4>
                <p className="text-xs text-stone-500 leading-relaxed font-medium">The single most important safety skill isn&apos;t fitness — it&apos;s the willingness to turn back if symptoms worsen. No view is worth pushing through warning signs of severe AMS.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="is-it-for-you" className="scroll-mt-12 space-y-6">
            <h2 className="text-2xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Is the Khayer Lake Trek Right for You?
            </h2>
            <div className="space-y-4 text-stone-650 text-sm">
              <h3 className="text-lg font-bold text-stone-950">Ideal Trekker Profile</h3>
              <p>This trek suits regular hikers with solid cardiovascular fitness, even without prior high-altitude experience, as long as they are willing to follow a sensible acclimatization schedule and pace themselves on the Khopra Ridge section.
              </p>

              <h3 className="text-lg font-bold text-stone-950">Who Should Take Extra Precautions</h3>
              <p>Trekkers with any history of heart or respiratory conditions, those who have had severe AMS on previous treks, and anyone unable to dedicate extra acclimatization time should consult a doctor beforehand and consider building additional rest days into their itinerary.
              </p>

              <h3 className="text-lg font-bold text-stone-950">When to Consider a Guided Trek</h3>
              <p>If this is your first high-altitude trek, traveling with an experienced guide adds a meaningful safety margin. A good guide monitors group pacing, recognizes early AMS symptoms before they become serious, and knows when a descent decision needs to be made — judgment that is hard to replace with research alone.
              </p>
            </div>
          </article>
          ...
          <article className="space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-sm">Khayer Lake&apos;s altitude is the defining fact of this trek, and everything else — the pacing, the acclimatization schedule, the choice of starting point — exists to manage it safely. At 4,660 meters, reaching the lake isn&apos;t about technical skill; it&apos;s about respecting what thin air does to your body and giving yourself enough time to adapt to it.
            </p>
            <p className="text-stone-600 leading-relaxed text-sm">For a reasonably fit trekker willing to follow a sensible itinerary, rest at Khopra Ridge before pushing higher, and listen to their body along the way, this trek is genuinely achievable. The difficulty is real, but it&apos;s also predictable and manageable once you understand where it comes from.
            </p>
          </article>
          ...
          <section className="bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white rounded-3xl p-8 shadow-md border border-stone-800 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 max-w-4xl">
              ...
              <p className="text-stone-300 text-sm leading-relaxed">Our guides are wilderness medical first responders. We can help you build an acclimatization schedule and itinerary suited to your experience level, so you reach Khayer Lake prepared rather than guessing.
              </p>
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">This altitude planner is verified by Nepal medical guide coordinators. All guides carry altitude sickness response sheets, diamox, and portable oxygen systems, and are trained to recognize early AMS symptoms.
              </p>
            </div>
          </div>
        </main>
