    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Weekly Trekking Fitness Plan
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Use this structured weekly training template to build leg strength, cardiovascular stamina, and backpack endurance for the trail.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">Follow this weekly cycle starting **8 weeks** before your departure. This schedule alternates between strength, aerobic threshold training, trail endurance, and mobility to prevent overtraining and build peak condition.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">Our guides are certified fitness coordinators. We recommend reviewing this program with your healthcare provider if you have any pre-existing joint or cardiovascular conditions.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">Book our guided departure today to secure your local guide, permits, and get detailed checklists for a successful trek.
            </p>
