    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khayer Lake Photography Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Capture the reflection. A professional guide to composition angles, polarizer setups, and lighting timing at the base of Annapurna South.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Khayer Lake (4,660m) offers one of the most dramatic mountain backdrops in the Himalayas. The turquoise glacial waters sit at the immediate foot of the south face of Annapurna South (7,219m), which rises like a giant wall straight out of the water.
          </p>
          <p>Due to the extreme altitude, dry air, and strong sun reflection off the glaciers, taking clean, professional photographs requires specific technical knowledge and composition adjustments.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">We run dedicated photography tours with extended stays on Khopra Ridge, allowing you to capture the golden hours in comfort.
            </p>
            <Link
              href="/#book"
