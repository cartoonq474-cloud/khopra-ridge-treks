        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#why-rapid" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Why Choose 5-Day?
              </a>
              <a href="#who-it-is-for" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Who This Trek is For
              </a>
              <a href="#detailed-itinerary" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Day-by-Day Itinerary
              </a>
              <a href="#route-profile" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Route Map &amp; Altitude
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="why-rapid" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm sm:text-base">🏔️ A Less Crowded Poon Hill Alternative</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <article id="difficulty" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 text-stone-650 text-sm">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-900 text-base">🏔️ Altitude &amp; Safety</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <article id="seasons" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-955 text-sm sm:text-base">❄️ Winter &amp; Monsoon</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
