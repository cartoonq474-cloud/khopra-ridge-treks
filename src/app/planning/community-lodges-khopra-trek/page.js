    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">The Community Lodge Network Model
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Trekking with a purpose. Learn how the collective village lodge system transforms tourism revenue into education and local development.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>The Khopra Ridge Trek is famous not just for its breathtaking views of Dhaulagiri, but for its pioneering social enterprise model. Developed in the early 2000s under the leadership of local visionary Mahabir Pun and the residents of Myagdi district, this network represents a departure from traditional capitalistic trekking trails.
          </p>
          <p>By establishing community-owned lodges at Bayeli, Chhistibung, Swanta, and Khopra Ridge, the villagers created a system where tourists directly support regional development, wildlife conservation, and public education.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Book your loop with us. We source all accommodation, foods, and logistical transfers through community network partners to maximize local economic benefit.
            </p>
            <Link
              href="/#book"
