    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Pokhara to Kimche Trailhead Transport
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Plan your transfer to the starting point of the Ghandruk climb. Compare private 4WD jeep options and local shared jeep departures from Pokhara.
          </p>
        </div>
        ...
        <div className="mt-16 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Kimche (1,640m) has become the preferred trailhead for hikers who want to bypass the dusty dirt roads between Nayapul and Ghandruk. Once your jeep drops you at the Kimche parking area, it is a pleasant, scenic **1-hour stone step climb** to reach the main village center of Ghandruk (1,940m), making it an easy first day of hiking.
          </p>
        </div>
