      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white py-24 px-6 border-b border-stone-800">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          <p className="mt-6 text-base md:text-lg lg:text-xl text-stone-300 max-w-4xl leading-relaxed font-medium">
            If you&apos;re researching the Khopra Trek cost, you&apos;ve probably already noticed that most guides only give you a rough package price and leave the rest to guesswork. That&apos;s not enough when you&apos;re trying to figure out whether this trip actually fits your travel budget.
          </p>
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#factors" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
              ...
              <a href="#staff" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Guide &amp; Porter Costs
              </a>
              ...
              <a href="#packages" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Trek Package Prices
              </a>
              <a href="#daily-examples" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
              ...
              <a href="#cash-atm" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Cash Planning &amp; ATMs
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              How Much Does the Khopra Trek Cost?
            </h2>
          ...
          <article id="factors" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              What Factors Affect the Cost of the Khopra Trek?
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">
              Two trekkers can walk the exact same route and end up with very different bills. Here&apos;s why:
            </p>
          ...
          <article id="breakdown" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Complete Khopra Trek Cost Breakdown
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">
            ...
            <div className="space-y-4 mt-6">
              ...
              <p className="text-stone-600 text-sm leading-relaxed">
                Every trekker entering the Annapurna Conservation Area needs the right paperwork. The <strong>Annapurna Conservation Area Permit (ACAP)</strong> is a flat fee of approximately $30 USD (3,000 NPR) per person. Combined with the <strong>TIMS Card</strong> ($15 USD / 2,000 NPR), the total fixed permit cost is $45 USD. You can obtain permits at the Nepal Tourism Board office in Kathmandu or Pokhara.
              </p>
          ...
          <article id="accommodation" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Khopra Trek Accommodation Cost
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">🏔️ Community Lodge Costs</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <article id="food-drinks" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Khopra Trek Food and Drink Cost
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">
            ...
            <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-4">
              <h4 className="font-bold text-stone-950 text-base">🍽️ Typical Meal and Drink Estimates</h4>
          ...
          <article id="staff" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Khopra Trek Guide and Porter Cost
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">
          ...
          <article id="independent-vs-guided" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Independent vs Guided Khopra Trek Cost
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">
          ...
          <article id="daily-examples" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Sample Khopra Trek Daily Budget Examples
            </h2>
          ...
          <article id="comparisons" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Khopra Trek Cost Comparison With Other Popular Treks
            </h2>
          ...
          <article id="reduce-budget" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              How to Reduce Your Khopra Trek Budget
            </h2>
          ...
          <article id="faq" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">
              Frequently Asked Questions About Khopra Trek Costs
            </h2>
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">
                This pricing guide is compiled and verified by licensed Pokhara-based guides and community lodge organizers. We audit trail costs, transportation fares, and lodge rates quarterly to provide the most transparent and accurate budget resource.
              </p>
            </div>
          </div>
        </main>
