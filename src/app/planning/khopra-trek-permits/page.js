        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">This guide is compiled and vetted by licensed Kathmandu-based guides and conservation area organizers. We monitor regulations and government policy updates weekly to ensure our permit resources remain the most accurate and up-to-date.
              </p>
            </div>
          </div>
        </main>
