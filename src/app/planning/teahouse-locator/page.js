        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#glance" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Stays at a Glance
              </a>
              <a href="#map-overview" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Route Map &amp; Overview
              </a>
              <a href="#directory" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Complete Directory
              </a>
              ...
              <a href="#community-network" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Community Network
              </a>
              ...
              <a href="#stops" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Recommended Stops
              </a>
              <a href="#khayer-stay" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Near Khayer Lake
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="glance" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-sm">🏔️ Overnights stops</h4>
                <p className="text-[10px] text-stone-500 leading-relaxed font-medium">
          ...
          <article id="stops" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3 text-stone-600 text-sm">
              ...
              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-sm">🏔️ Khayer Lake Stay</h4>
                <p className="mt-2 text-[10px] text-stone-500 leading-relaxed font-medium">
          ...
          <article id="khayer-stay" className="scroll-mt-12 space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-sm">
              There is no overnight accommodation directly at Khayer Lake (4,660m). The closest lodge is <strong>Khopra Ridge Community Lodge</strong> (3,660m), located a 5 to 6-hour walk below. Trekkers use it as their base, starting the lakeside day-hike early in the morning and returning to the same lodge for their second night.
            </p>
          </article>
