        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="p-8 bg-stone-100 border border-stone-200 rounded-3xl flex flex-col justify-between">
            ...
            <div className="mt-8 pt-6 border-t border-stone-200/60 text-[10px] text-stone-600 leading-relaxed">
              *Calculations are based on average trail gradients, high sleeping altitudes at Dobato and Khopra Ridge, and the 1,000m ascent to <Link href="/routes/khopra-ridge-to-khayer-lake" className="text-emerald-700 underline font-semibold hover:text-emerald-600">Khayer Lake</Link>.
            </div>
          </div>
