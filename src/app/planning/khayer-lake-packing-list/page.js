    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khayer Lake Day Hike Packing List
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Pack smart, travel light. A detailed daypack checklist covering hydration, emergency layers, and safety equipment for the 10-hour alpine hike.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>When making the day-long push from Khopra Ridge (3,660m) to Khayer Lake (4,660m), you will leave your heavy duffel bag or backpack at the community lodge. You will only carry a 20-30L daypack.
          </p>
          <p>Because the trail leads through raw, unpopulated wilderness with no shelter, your daypack must contain all essential clothing layers, snacks, and safety gear to handle extreme cold, sudden snowstorms, or fog.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Our guides carry emergency shelters, pulse oximeters, satellite trackers, and comprehensive medical kits on all Khayer Lake excursions.
            </p>
            <Link
              href="/#book"
...
export const metadata = {
  alternates: {
    canonical: '/planning/khayer-lake-packing-list',
  },
};
