    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khayer Baraha Temple Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Discover the spiritual heart. A comprehensive guide to the historical background, religious festivals, and architecture of the lakeside shrine.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>The Khayer Baraha Temple is a small, slate-stone temple complex situated on the banks of Khayer Lake (4,660m). Dedicated to the goddess Baraha (the wild boar avatar of Lord Vishnu in Hindu mythology), this isolated shrine represents one of the most sacred high-altitude pilgrimage sites in the Gandaki province of Nepal.
          </p>
          <p>For local communities (primarily Gurungs and Magars living in the valleys below), the lake and the temple are holy ground. Hikers are requested to treat the site with utmost respect.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Our guides are local residents who can explain the mythology, history, and spiritual practices of the temple during your visit.
            </p>
            <Link
              href="/#book"
...
export const metadata = {
  alternates: {
    canonical: '/planning/khayer-baraha-temple-guide',
  },
};
