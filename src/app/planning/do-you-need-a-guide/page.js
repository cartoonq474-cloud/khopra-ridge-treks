    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Do You Need a Guide for the Khopra Trek?
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Understand Nepal&apos;s guide regulations. Review official tourism rules, path-finding safety in thick forests, and high-altitude lodge booking logistics.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Yes. The Nepal government officially prohibits solo, unguided trekking for international travelers in all national parks and conservation areas (including the Annapurna Conservation Area) to ensure safety and rescue efficiency.
          </p>
          <p>Beyond legal compliance, the remote nature of the Khopra trail makes having a professional guide a major safety asset. The path receives far less traffic than standard routes, and having an experienced local leader is crucial for handling emergency logistics.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Ensure safety and regulatory compliance. Inquire about our guided packages led by certified, first-aid trained local guides.
            </p>
            <Link
              href="/#book"
