    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khayer Lake Day Hike Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">The ultimate summit timeline. A detailed hour-by-hour pacing schedule, trail walkthrough, and checkpoints for the 10-hour round-trip trek.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Our guides arrange advance safety planning, carry pulse oximeters, coordinate emergency procedures, and pace your ascent safely to guarantee a successful day hike.
            </p>
            <Link
              href="/#book"
...
export const metadata = {
  alternates: {
    canonical: '/planning/khayer-lake-day-hike',
  },
};
