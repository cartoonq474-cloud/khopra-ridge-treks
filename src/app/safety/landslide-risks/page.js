    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Landslide & Rockfall Risks on the Khopra Trail
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Understand landslide danger zones, mudslide risk seasons, and the standard trail safety procedures to follow when crossing active scree slopes.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">The geological structure of the Himalayas is relatively young and active, which means soil erosion and landslides are natural processes, particularly in steep river gorges. 
          </p>
          <p className="text-stone-600 leading-relaxed">On the Khopra Ridge Trek, the lower segments (around Swanta and the valleys between Ghandruk and Tadapani) contain regions where slopes can become unstable, especially after heavy rains. Managing these risks involves seasonal awareness and trail discipline.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">Our guides examine alternative trails and coordinate with local checkposts daily. If a landslide blocks the main trail, we reroute through safe alternative pathways.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">Book our guided departure. Get an experienced local leader who knows all trail detours, safety procedures, and handles all checkpost permits.
            </p>
