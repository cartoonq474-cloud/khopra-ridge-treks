    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Travel Insurance for Trekking in Nepal
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Do not hike without coverage. A comprehensive checklist of required policy clauses, altitude riders, and helicopter evacuation terms for the Khopra circuit.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">While we manage all trail logistics and safety plans, we cannot cover emergency hospital or evacuation fees. Himalayan helicopter rescues are highly efficient but expensive, averaging between **$2,500 and $5,000 per flying hour**. 
          </p>
          <p className="text-stone-600 leading-relaxed">Helicopter pilots in Nepal will not launch unless they receive a direct guarantee of payment from an insurance coordinator or a cash deposit. Having a certified trekking policy ensures you receive immediate rescue if an emergency happens.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">We check insurance validation copies for all clients before departure. If your policy lacks helicopter rescue terms, we can recommend local supplementary riders.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">Book our guided departure to get access to pre-departure safety briefings, certified guides, and guaranteed lodge space.
            </p>
