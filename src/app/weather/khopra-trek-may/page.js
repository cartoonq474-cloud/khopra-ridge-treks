    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khopra Ridge Weather in May
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Plan for late spring. Review average high/low temperatures, pre-monsoon rain expectations, visibility index, and gear advice for May.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">May is the final month of the spring trekking season in Nepal. It features warm temperatures throughout the route, making the high-elevation nights at Khopra Ridge (3,660m) and Bayeli Kharka (3,425m) far more comfortable than in earlier months.
          </p>
          <p className="text-stone-600 leading-relaxed">As the pre-monsoon heat builds up, afternoon cloudiness and localized showers become more frequent. However, mornings are still clear, offering beautiful views before the clouds roll in. Trekkers can enjoy quiet trails as the spring crowds start to taper off.
          </p>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">May offers warmer climbing conditions and quieter paths. Coordinate your custom trekking itinerary with our certified guides today.
            </p>
...
export const metadata = {
  alternates: {
    canonical: '/weather/khopra-trek-may',
  },
};
