    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khopra Ridge Weather in January
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Plan for peak winter. Review average high/low temperatures, snow expectations, visibility index, and gear advice for January.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">January is the heart of winter in the Annapurna region. While lower sections of the trek like Ghandruk remain relatively mild during the day, high-altitude ridges like Khopra Ridge (3,660m) experience freezing conditions, especially after the sun sets.
          </p>
          <p className="text-stone-600 leading-relaxed">The major advantage of trekking in January is the exceptional visibility. The winter air is dry and crisp, offering crystal-clear mountain views of Dhaulagiri, Annapurna South, and Nilgiri in the mornings. Additionally, trails are incredibly quiet, offering a peaceful experience.
          </p>
          <p className="text-stone-600 leading-relaxed">Trekkers must prepare for temperatures dropping well below freezing at night. High-altitude community lodges have wood stoves in the common areas, but bedrooms are unheated. A high-quality down sleeping bag (-20°C rated) and four-season layers are mandatory.
          </p>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">January offers unparalleled winter clarity for experienced trekkers. Secure your permit-inclusive booking packages with our local team.
            </p>
...
export const metadata = {
  alternates: {
    canonical: '/weather/khopra-trek-january',
  },
};
