    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Machhapuchhre Views from the Trail
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Machhapuchhre (6,993m), the iconic Fishtail Mountain, frames the eastern sky throughout the trek, showing its famous double-summit profile.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Machhapuchhre, which translates to **&quot;Fish Tail&quot;** in Nepali, is one of the most recognizable peaks in the Himalayas. Its vertical slopes rise directly from the Pokhara valley. Because of its religious association with the Hindu god Shiva, the peak is considered holy, and the government of Nepal has banned climbing on it. It remains unclimbed to this day.
          </p>
          <p>On the Khopra trek, you will get spectacular, unobstructed views of Machhapuchhre from the stone alleys of Ghandruk village, the forest clearing of Tadapani, and the open ridge of Muldai Viewpoint. From Khopra Ridge itself, you can spot its sharp pointed tip rising above the eastern valley clouds.
          </p>
        </div>
...
export const metadata = {
  alternates: {
    canonical: '/mountains/machhapuchhre-views',
  },
};
