    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Himalayan Mountain Identification Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Identify the peaks. A visual profile guide mapping peak heights, shapes, and viewpoints for Dhaulagiri, Annapurna South, Nilgiri, and Machhapuchhre.
          </p>
        </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">We compile data from topographic records of the Survey Department of Nepal. Our guides carry mountain identification charts for clients.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">Want to trek with a licensed guide who knows every peak and viewpoint? Secure your permit-inclusive booking packages with our local team.
            </p>
