    ...
    <div className="w-full flex-1">
      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Dhaulagiri Views from Khopra Ridge
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Khopra Ridge sits directly across the Kali Gandaki Valley from Dhaulagiri I, offering an unobstructed view of the seventh-highest mountain on Earth.
          </p>
        </div>
