        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#importance" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Why Stop Here?
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="route" className="scroll-mt-12 space-y-6">
            ...
            <div className="space-y-6 text-stone-600 text-sm leading-relaxed">
              ...
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">⛰️ Bayeli Kharka to Chistibung</h4>
                <p className="mt-1">
          ...
          <article id="best-time" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">❄️ Winter Conditions</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">🌧️ Monsoon Season (June to September)</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">
          ...
          <section id="booking" className="scroll-mt-12 bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white rounded-3xl p-8 shadow-md border border-stone-800 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 max-w-4xl">
              ...
              <p className="text-stone-300 text-sm leading-relaxed">
                We manage all the logistics — permits, lodging, transport, and safety — so you can focus on the trail. Join our next 9-Day Khopra Ridge Trek and experience Bayeli Kharka for yourself.
              </p>
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">
                This Bayeli Kharka guide is reviewed by certified local guides based in Pokhara. We regularly inspect weather patterns, trailhead details, and village community registries to keep our details current.
              </p>
            </div>
          </div>
        </main>
