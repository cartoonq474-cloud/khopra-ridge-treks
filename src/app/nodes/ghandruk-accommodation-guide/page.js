    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Ghandruk Accommodation & Teahouse Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Find the perfect stay. Understand teahouse categories, average costs, and facility standards in the most developed village along the loop.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Unlike the higher, more rustic community stops along the Khopra Ridge circuit (like Chhistibung and Bayeli), Ghandruk offers a wide variety of lodging options. From heritage hotels with premium mattresses and attached tiled bathrooms to simple family homestays, you can tailor your stay to match your preferred level of comfort.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Our guided packages include overnight stays at top-rated, comfortable Ghandruk lodges featuring private bathrooms and beautiful sunrise balconies.
            </p>
            <Link
              href="/#book"
