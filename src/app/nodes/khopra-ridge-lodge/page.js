        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#what-is-lodge" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                What is the Lodge?
              </a>
              <a href="#community-model" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Community Tourism Model
              </a>
              <a href="#location-access" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Where is it Located?
              </a>
              ...
              <a href="#safety-altitude" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Altitude &amp; Safety
              </a>
              ...
              <a href="#plan-book" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Plan &amp; Book
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            ...
            <div className="bg-emerald-50 border border-emerald-100 rounded-3xl p-6 md:p-8 mt-6">
              <p className="text-emerald-950 font-bold text-base leading-relaxed">
                Planning a Khopra Ridge Trek? Our local team handles permits, accommodation, guides, and transport.
              </p>
              <Link 
                href="/contact" 
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-stone-600 leading-relaxed text-sm mt-2">
                  The lodge elevation is 3,660 meters above sea level — high enough to place guests above the treeline, inside the alpine zone, and in full view of the Himalayan giants that ring the western Annapurna circuit. The nearest settlements below are <Link href="/nodes/chhistibung-guide" className="text-emerald-700 font-bold hover:underline">Chhistibung</Link> (roughly 2,870m) and <Link href="/nodes/swanta-village-guide" className="text-emerald-700 font-bold hover:underline">Swanta Village</Link> — both connected to the lodge by well-established trekking trails.
                </p>
              </div>
          ...
          <article id="accommodation" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">🛏️ Room Types and Sleeping</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <article id="mountain-views" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">🏔️ Dhaulagiri &amp; Western Peaks</h4>
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">🏔️ Annapurna South, Nilgiri &amp; Machhapuchhre</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">
          ...
          <article id="safety-altitude" className="scroll-mt-12 space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-200 p-6 rounded-2xl space-y-3">
              <h4 className="font-bold text-amber-950 text-base">⚠️ Prevention &amp; Safety Strategies</h4>
          ...
          <section id="booking" className="scroll-mt-12 bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white rounded-3xl p-8 shadow-md border border-stone-800 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 max-w-4xl">
              ...
              <p className="text-stone-300 text-sm leading-relaxed">
                Arranging the Khopra Ridge Trek involves permits, accommodation sequencing, guide logistics, and transport from Pokhara — all of which our team manages directly for you.
              </p>
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">
                This Khopra Ridge Community Lodge guide is reviewed by certified local guides based in Pokhara. We regularly inspect road conditions, trailhead access, and community lodge operations to keep our details current.
              </p>
            </div>
          </div>
        </main>
