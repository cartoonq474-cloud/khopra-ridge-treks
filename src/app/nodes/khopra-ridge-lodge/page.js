...
export const metadata = {
  ...
  title: "Khopra Ridge Community Lodge: Complete Guide for Trekkers",
  description: "Discover everything about the Khopra Ridge Community Lodge at 3,660m — rooms, facilities, mountain views, community tourism impact, Khayer Lake access, and.",
};
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">This Khopra Ridge Community Lodge guide is reviewed by certified local guides based in Kathmandu. We regularly inspect road conditions, trailhead access, and community lodge operations to keep our details current.
              </p>
            </div>
          </div>
        </main>
