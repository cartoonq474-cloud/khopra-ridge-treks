    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen font-sans antialiased flex flex-col justify-between">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white py-24 px-6 border-b border-stone-800">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/35 px-4 py-1 text-xs font-bold text-emerald-400 uppercase tracking-widest mb-6">Trekking Sunrise Hub
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight max-w-5xl">Ghorepani Village: Poon Hill Sunrise Trek Hub in the Annapurna Region
          </h1>
          <p className="mt-6 text-base md:text-lg lg:text-xl text-stone-300 max-w-4xl leading-relaxed font-medium">If you ask any guide in Pokhara where to catch the best sunrise in the Annapurna region, most will point you toward Ghorepani Village. Sitting at 2,860 meters on a centuries-old trade route, Ghorepani has become one of the busiest and most important trekking villages in Nepal — not because it&apos;s a final destination, but because of what it connects to.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12 w-full flex-1">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#reach" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">How to Reach It
              </a>
              <a href="#poonhill" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Poon Hill Hike
              </a>
              <a href="#routes" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Trek Route Options
              </a>
              <a href="#hub" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Trekking Hub Role
              </a>
              <a href="#rhododendrons" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Rhododendron Bloom
              </a>
              <a href="#villagelife" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Teahouse Experience
              </a>
              <a href="#difficulty" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Difficulty &amp; Prep
              </a>
              <a href="#besttime" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Best Time to Visit
              </a>
              <a href="#summary" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Why Perfect Hub
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Ghorepani Village Guide
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">This is the launching point for the famous Poon Hill sunrise hike, where Dhaulagiri, Nilgiri, and the Annapurna range catch the first light of day. It&apos;s also a trail junction, where routes split toward Tadapani, Ghandruk, Swanta, Tatopani, and eventually <Link href="/" className="text-emerald-700 underline font-semibold hover:text-emerald-600">Khopra Ridge</Link>. In spring, the surrounding hills turn into one of the world&apos;s largest rhododendron canopies.
            </p>
            <p className="text-stone-600 leading-relaxed text-base">In this guide, we&apos;ll cover where Ghorepani is, how to get there from Pokhara, what the Poon Hill sunrise hike actually involves, the route options that branch out from the village, and how Ghorepani fits into a longer Annapurna trekking plan — including the connection to our Khopra Ridge trek.
            </p>
          </article>

          {/* SECTION 2: LOCATION */}
          <article id="location" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Where is Ghorepani Village Located?
            </h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-stone-900">Ghorepani in the Annapurna Conservation Area</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Ghorepani sits inside the Annapurna Conservation Area, Nepal&apos;s largest protected area and one of the most biodiverse trekking regions in the Himalayas. The village rests at roughly 2,860 meters (9,383 feet), high enough for cool mountain air and clear forest views, but low enough to remain accessible to trekkers of most fitness levels.
                </p>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Geographically, Ghorepani occupies a saddle point between two ridgelines. This position is exactly why it became a trade pass centuries ago, and exactly why it works so well as a trekking hub today — trails arrive from the south and continue north, east, and west in several directions.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-stone-900">Why Ghorepani is a Trekking Hub</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">A &quot;hub&quot; village isn&apos;t just a stop along a trail. It&apos;s a place where multiple route options converge, giving trekkers a choice of where to go next. Ghorepani fits this description better than almost any other village in the Annapurna foothills.
                </p>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">From Ghorepani, you can hike up to Poon Hill for sunrise, then continue east toward Tadapani and Ghandruk, or descend west toward Swanta and Tatopani. From Swanta, a trail climbs toward Chhistibung and Khopra Danda. Few villages at this elevation offer this much route flexibility, which is why so many multi-day itineraries are built around it.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-stone-900">Cultural Identity of Ghorepani</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Ghorepani sits in an area shaped by both Magar and Gurung communities, two of the ethnic groups most closely associated with trekking guide and porter work in Nepal. Many of the teahouses here are family-run, often for generations, and the architecture, food, and daily rhythm of the village reflect mountain life rather than tourist infrastructure built from scratch.
                </p>
              </div>
            </div>
          </article>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                  ...
                  <p className="text-xs text-stone-500 leading-relaxed">From Nayapul, the trail follows the Modi Khola river valley before climbing steadily toward the village of Tikhedhunga. The real climb begins after Tikhedhunga, at Ulleri. Here, the trail turns into a long stone staircase — locally famous, and not always loved — that climbs roughly 1,500 steps up a steep hillside.
                  </p>
                </div>
                <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                  <h4 className="font-bold text-stone-950 text-base">Trek Duration and Difficulty</h4>
                  <p className="text-xs text-stone-500 leading-relaxed">Most itineraries split this approach into two days: Day 1 from Nayapul to Tikhedhunga or Ulleri (3–4 hours), and Day 2 from Ulleri to Ghorepani (3–4 hours, mostly uphill). Combined, you are looking at 6–8 hours of walking, with a total elevation gain of around 1,400 meters.
                  </p>
                </div>
              </div>
            </div>
          ...
          <article id="poonhill" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Ghorepani to Poon Hill Sunrise Hike
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-3xl shadow-sm space-y-3">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">Trekkers typically leave their teahouse between 4:30 and 5:00 AM, walking by headlamp along a stone-paved trail. The climb from Ghorepani to Poon Hill covers about 450 meters of elevation gain over roughly 45 minutes to an hour.
                </p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-3xl shadow-sm space-y-3">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">At 3,210 meters, Poon Hill&apos;s viewing platform opens onto a complete panorama: Dhaulagiri (8,167m), the Annapurna range including Annapurna South and Annapurna I, Nilgiri, Machhapuchhre, and Hiunchuli.
                </p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-3xl shadow-sm space-y-3">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">Poon Hill&apos;s reputation comes down to accessibility vs. reward. Unlike high-altitude viewpoints that demand days of acclimatization, Poon Hill is reachable on a short pre-dawn hike from a comfortable teahouse.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="routes" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Ghorepani Trek Routes and Trail Options
            </h2>

            <div className="space-y-6 text-stone-600 text-sm leading-relaxed">
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">Ghorepani to Tadapani Route</h4>
                <p className="mt-1">After the Poon Hill sunrise, many trekkers continue east toward Tadapani. This route winds through dense rhododendron and oak forest, with several ridge sections offering ongoing views of the Annapurna range. The walk typically takes 5–6 hours. From Tadapani, trails continue toward Ghandruk.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">Ghorepani to Swanta and Tatopani Descent</h4>
                <p className="mt-1">Alternatively, trekkers heading west descend through forest toward Swanta Village, and onward to Tatopani, known for its natural hot springs beside the Kali Gandaki river. This route trades forest ridgelines for a steady descent into the river valley.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">Ghorepani to Khopra Ridge Extension</h4>
                <p className="mt-1">Ghorepani connects directly into the Khopra Ridge system. The route runs from Ghorepani down to Swanta, then climbs through Chhistibung toward Khopra Danda. This extension turns a 3–4 day Poon Hill trip into a longer Annapurna adventure, typically adding 4–5 days.
                </p>
              </div>
            </div>
          ...
          <article id="hub" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Ghorepani as a Trekking Hub in the Annapurna System
            </h2>
          ...
          <article id="rhododendrons" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Rhododendron Forest Experience in Ghorepani
            </h2>

            <div className="grid gap-6 md:grid-cols-3">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Spring Bloom</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">During March and April, the hillsides surrounding the village turn shades of deep red, pink, and white. Nepal&apos;s national flower blankets the trails during this window. Late March through mid-April is the most reliable period.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Forest Environment</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">Lower sections near Tikhedhunga are subtropical, while higher up, rhododendron and oak forest takes over. This forest is part of a wider habitat supporting numerous bird species, making it popular with birdwatchers.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Photography</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">The combination of a forest in full bloom and a Himalayan sunrise is rare. Photographers often time their visit specifically for the rhododendron season, using the sunrise as the headline shot.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="villagelife" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Ghorepani Village Life and Teahouse Experience
            </h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-stone-900">Teahouse and Mountain Lodge System</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">With more than 30 teahouses, Ghorepani has one of the densest concentrations of lodging in the Annapurna foothills. Most operate on the standard teahouse model: simple twin rooms, shared bathrooms (though attached bathrooms are increasingly common), and a communal dining hall heated by a central stove. Hot showers, charging points, and Wi-Fi are usually available for a small fee.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-stone-900">Food and Trekking Hospitality</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Teahouse menus in Ghorepani follow the familiar Annapurna pattern: dal bhat (lentils, rice, and vegetable curry), noodle and pasta dishes, soups, and basic breakfast items like porridge, eggs, and Tibetan bread. Many lodges also serve fresh apple pie, a regional specialty that has become a tradition along this route.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-stone-900">Local Culture of Magar and Gurung Communities</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">The people who run Ghorepani&apos;s teahouses are part of a longer tradition of mountain hospitality rooted in Magar and Gurung culture. Many families have worked in trekking tourism for decades, and that experience shows in how smoothly the village handles its busiest periods.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="difficulty" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Difficulty Level and Trek Preparation
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-sm uppercase tracking-wide border-b border-stone-100 pb-2 mb-3">Moderate Difficulty</h4>
                <p className="text-xs text-stone-500 leading-relaxed">The trek is moderate, requiring no technical skills or previous high-altitude experience. Trekkers comfortable walking 4–6 hours a day with a daypack typically manage without issues.
                </p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">Climbing roughly 1,500 steps in succession is the steepest sustained climb on the route. The key to managing it is pacing — a slow, steady rhythm works far better than fast bursts.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-sm uppercase tracking-wide border-b border-stone-100 pb-2 mb-3">Altitude &amp; Safety</h4>
                <p className="text-xs text-stone-500 leading-relaxed">At 2,860 meters, Ghorepani sits below the altitude where AMS becomes a major concern. The bigger practical concerns are temperature (Poon Hill mornings are cold) and physical fatigue.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="besttime" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Best Time to Visit Ghorepani Village
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-stone-600 text-sm">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                ...
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">Spring is best for the rhododendron bloom. The forest canopy comes alive, and daytime temperatures are comfortable, though trails and teahouses can be busy.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Autumn (Oct–Nov)</h4>
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">Autumn is widely considered the best season for mountain visibility. Post-monsoon skies tend to be very clear, giving the sharpest views of Dhaulagiri and Annapurna.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Winter (Dec–Feb)</h4>
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">Winter brings colder temperatures and snow. Trails are quieter, teahouses are easier to book, and views can be exceptionally crisp — though mornings are very cold.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="summary" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Why Ghorepani is the Perfect Trekking Hub
            </h2>
          ...
          <article id="plan" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Plan Your Ghorepani &amp; Poon Hill Trek
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">If you&apos;re putting together a trekking itinerary in the Annapurna region, Ghorepani is one of the most useful villages to build around. Whether your plan is a short 3–4 day Poon Hill trip or a longer route extending toward Khopra Ridge, the logistics — access from Pokhara, the Ulleri climb, teahouse availability, and onward route options — all come together here.
            </p>
            <p className="text-stone-600 leading-relaxed text-sm">Our guides are based locally in Pokhara and manage permits, lodging, and route planning for treks through this region, including our 9-Day Khopra Ridge trek, which uses Ghorepani and the Poon Hill sunrise as its opening highlight before continuing toward Khopra Danda.
            </p>
          </article>

          {/* SECTION 13: FAQS */}
          <article id="faq" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Frequently Asked Questions About Ghorepani Village
            </h2>
          ...
          <article className="space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-sm">Ghorepani Village earns its place at the center of Annapurna trekking not by being a destination in itself, but by being the point where everything connects. It&apos;s the launch pad for the Poon Hill sunrise, a passage through one of the world&apos;s great rhododendron forests, and a junction leading toward Tadapani, Swanta, Tatopani, and the Khopra Ridge system.
            </p>
            <p className="text-stone-600 leading-relaxed text-sm">Whether you&apos;re planning a short sunrise trip or building a longer Annapurna itinerary, understanding how Ghorepani fits into this wider trail network is the key to getting the most out of your trek.
            </p>
          </article>
          ...
          <section id="booking" className="scroll-mt-12 bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white rounded-3xl p-8 shadow-md border border-stone-800 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 max-w-4xl">
              ...
              <p className="text-stone-300 text-sm leading-relaxed">Our local guides handle permits, lodging, and route planning across the Annapurna region — including the 9-Day Khopra Ridge trek, which begins with the Poon Hill sunrise from Ghorepani.
              </p>
