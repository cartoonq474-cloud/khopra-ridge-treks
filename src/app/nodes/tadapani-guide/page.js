      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Tadapani is a vital crossroads in the Annapurna trail network, linking Ghandruk, Ghorepani, and the offbeat route to Bayeli Kharka and Khopra Ridge.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 rounded-2xl border border-stone-200 bg-white p-6 sm:grid-cols-4">
            ...
            <p className="mt-1 text-sm font-bold text-stone-900">2,630 m</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Primary Forest</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Rhododendron & Oak</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Trail Access</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Ghandruk, Ghorepani, Bayeli</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Key View</span>
