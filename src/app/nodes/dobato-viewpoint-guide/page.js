      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12 w-full flex-1">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#reach-muldai" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Step-by-Step Route
              </a>
              ...
              <a href="#difficulty-safety" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Difficulty &amp; Safety
              </a>
              ...
              <a href="#muldai-vs-poonhill" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Muldai vs Poon Hill
              </a>
              <a href="#itinerary-integration" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">
                Trek Integration
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-base">
              Whether you&apos;re adding Muldai to a <Link href="/guides/khopra-ridge-ultimate-guide" className="text-emerald-700 font-bold hover:underline">Khopra Ridge Trek</Link>, a Ghorepani–Poon Hill loop, or planning it as a standalone highlight, you&apos;ll find the practical details here to prepare with confidence.
            </p>
          ...
          <article id="location" className="scroll-mt-12 space-y-6">
            ...
            <div className="bg-emerald-50 border border-emerald-200 p-6 rounded-2xl">
              <h4 className="font-bold text-emerald-950 text-sm">🏔️ Why Muldai&apos;s Altitude Matters for the Views</h4>
          ...
          <article id="sunrise-experience" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base font-sans font-sans">🏔️ Alpenglow Peak Progression</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <article id="mountains-visible" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">🏔️ Dhaulagiri Range</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">🏔️ Annapurna Massif</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <article id="difficulty-safety" className="scroll-mt-12 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-sm sm:text-base">⛰️ Altitude Awareness at 3,637m</h4>
                <p className="mt-2 text-xs sm:text-sm text-stone-500 leading-relaxed">
          ...
          <article id="itinerary-integration" className="scroll-mt-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">🏔️ Khopra Ridge Trek Connection</h4>
                <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">
                This guide is maintained and reviewed by our licensed local trekking guides operating out of Pokhara. We regularly update routes, weather advisories, and community lodge statuses based on active trail checks to ensure our information remains the gold standard.
              </p>
            </div>
          </div>
        </main>
