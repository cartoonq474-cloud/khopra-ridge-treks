...
export const metadata = {
  ...
  title: "Kimche: The Jeep Road Trailhead for Ghandruk and",
  description: "Kimche is the highest jeep-accessible point on the road from Pokhara toward Ghandruk. Learn why trekkers choose Kimche as their starting point, how to get.",
};
    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen font-sans antialiased flex flex-col justify-between">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white py-24 px-6 border-b border-stone-800">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/35 px-4 py-1 text-xs font-bold text-emerald-400 uppercase tracking-widest mb-6">Highest Jeep Terminus Node
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight max-w-5xl">Kimche: The Jeep Road Trailhead for Ghandruk and Annapurna Treks
          </h1>
          <p className="mt-6 text-base md:text-lg lg:text-xl text-stone-300 max-w-4xl leading-relaxed font-medium">If you are planning a trek into the Annapurna region and looking for the fastest, most scenic way to begin, Kimche is where your walk starts. Sitting at 1,640 metres above sea level, Kimche is the highest point a vehicle can reach on the mountain road that climbs up from Nayapul. From here, the jeep stops, the road ends, and the stone staircase begins.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12 w-full flex-1">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              ...
              <a href="#where-is-kimche" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Where is Kimche?
              </a>
              <a href="#why-start-here" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Why Start Here?
              </a>
              ...
              <a href="#road-conditions" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Road Conditions
              </a>
              <a href="#hike-to-ghandruk" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Hike to Ghandruk
              </a>
              <a href="#kimche-vs-nayapul" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Kimche vs Nayapul
              </a>
              ...
              <a href="#best-time" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Best Time to Start
              </a>
              <a href="#practical-tips" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Practical Pre-Trek Tips
              </a>
              <a href="#local-guide-insights" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Local Guide Insights
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="why-start-here" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Why Trekkers Start Their Journey at Kimche
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">Starting at Kimche represents a modern approach to planning treks in the Annapurna Conservation Area, maximizing time spent on scenic trails.
            </p>

            <div className="grid gap-6 md:grid-cols-3">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Skip Dusty Road Walking</h4>
                <p className="text-xs text-stone-500 leading-relaxed">The traditional starting point was Nayapul, but much of that lower section follows the same unpaved road that vehicles use — bringing dust, noise, and limited scenery. Taking a jeep to Kimche skips this entirely.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Save 3–4 Hours of Time</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Walking from Nayapul to Kimche takes roughly 3 to 4 hours. Starting at Kimche instead saves significant energy on the first day, which makes a meaningful difference to shorter or compact itineraries.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Start on Scenic Trails</h4>
                <p className="text-xs text-stone-500 leading-relaxed">The moment you step out of the jeep at Kimche, you are already on the stone staircase path leading up to Ghandruk village. There is no transition period — you begin climbing through terraces immediately.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="how-to-reach" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">How to Reach Kimche from Pokhara
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">Getting to Kimche from Pokhara Lakeside requires booking private mountain transport due to the rough terrain of the foothills.
            </p>

            <div className="space-y-6 text-stone-600 text-sm leading-relaxed">
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">Private Jeep Transportation</h4>
                <p className="mt-1">The standard and most reliable way to reach Kimche is by private 4WD jeep from Pokhara. This is the option used by the large majority of guided trekkers as well as experienced independent travelers. A private jeep gives you flexibility over departure time, direct drop-off at the Kimche trailhead, and the ability to carry trekking luggage without restriction.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">Travel Time and Route Overview</h4>
                <p className="mt-1">The jeep route from Pokhara follows the main highway west before turning onto the mountain road that climbs toward Nayapul and beyond. The full journey from Pokhara to Kimche typically takes between 1.5 and 2 hours under normal conditions. Road quality varies significantly by season: dry months are reasonably comfortable, while rain can slow progress considerably.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-stone-900 text-base flex items-center gap-2">Typical Jeep Costs and Sharing</h4>
                <p className="mt-1">A private 4WD jeep from Pokhara to Kimche generally costs in the range of 7,000 to 9,000 NPR for the whole vehicle. This cost is typically the same whether you are one person or a group of four to five, making it very reasonable when split between trekking companions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-emerald-50 border border-emerald-200 p-6 rounded-2xl mt-4">
              ...
              <p className="text-xs text-emerald-900 leading-relaxed mt-1">An early departure from Pokhara — ideally between 6:00 and 7:30 in the morning — allows you to reach Kimche and begin the climb to Ghandruk during the cooler morning hours. Arriving at Ghandruk before midday also gives you time to settle in, eat lunch with views of the Annapurna range, and rest before the afternoon.
              </p>
            </div>
          </article>
          ...
          <article id="road-conditions" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Road Conditions Between Nayapul and Kimche
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">The road between Nayapul and Kimche is an unpaved mountain dirt road. It follows narrow ledges above the Modi Khola gorge, crosses small seasonal streams, and passes through hillside settlements. It requires a driver with experience and a vehicle with proper ground clearance.
            </p>

            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Dry Season Conditions</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">During spring (March to May) and autumn (September to November), the road is generally in its best condition. The surface is firmer, stream crossings are easier to manage, and the risk of unexpected closures is lower.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Monsoon Challenges</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">From June through September, heavy and sustained rainfall can trigger minor landslides, wash out stream crossings, and make sections of the road temporarily impassable. If trekking in monsoon, check statuses daily with our Pokhara coordinator.
                </p>
              </div>
            </div>

            <div className="bg-amber-50 border border-amber-200 p-6 rounded-2xl mt-4">
              <h4 className="font-bold text-amber-950 text-sm">High-Clearance 4WD is Mandatory</h4>
              <p className="text-xs text-amber-950 leading-relaxed mt-1">A standard sedan or minivan is not suitable for this road in any season. The unpaved surface, combined with steep gradients and seasonal debris, requires a high-clearance 4WD vehicle with good traction. Do not accept low-clearance vehicle alternatives regardless of what a local transport tout may suggest.
              </p>
            </div>
          </article>
          ...
          <article id="hike-to-ghandruk" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">The Kimche to Ghandruk Trek
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">The walk from the trailhead up to Ghandruk is short but involves a steady climb on stone steps.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-stone-600 text-sm">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                ...
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">The climb covers a modest horizontal distance but gains roughly 500 metres in altitude, taking about 1 to 1.5 hours at a comfortable pace.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Stone Staircase Trail</h4>
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">The trail is exceptionally well-maintained, following hand-carved stone staircases. It is well-marked and easy to navigate with no major junctions.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Valley &amp; Farm Vistas</h4>
                <p className="mt-2 text-xs text-stone-500 leading-relaxed">The path winds through agricultural terraces and tea plantations. On clear mornings, Annapurna South, Hiunchuli, and Machhapuchhre peaks emerge above the ridge.
                </p>
              </div>
            </div>

            <p className="text-stone-600 leading-relaxed text-sm mt-4">Upon reaching Ghandruk, you will enter a large Gurung village with teahouses, restaurants, a cultural museum, and stunning views of the Annapurna range. From Ghandruk, paths branch north toward Annapurna Base Camp and west toward Tadapani, Ghorepani, and the Khopra Ridge circuit. Learn more in our <Link href="/nodes/ghandruk-village-guide" className="text-emerald-700 font-bold hover:underline">Ghandruk Village Guide</Link>.
            </p>
          </article>

          {/* SECTION 7: KIMCHE VS NAYAPUL */}
          <article id="kimche-vs-nayapul" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Kimche vs Nayapul: Which Is the Better Trekking Start?
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">For the majority of trekkers — especially those on guided treks, shorter itineraries, or first-time visits to the Annapurna region — Kimche is the better starting point.
            </p>
          ...
          <article id="trekking-routes" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Trekking Routes That Begin Through Kimche
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">Kimche serves as the primary gateway for several major routes:
            </p>
          ...
          <article id="facilities-services" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Facilities and Services Available at Kimche
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">Kimche&apos;s trailhead area is modest. It is a functional stopping point rather than a developed tourist hub. The jeep drops you off at the base of the stone staircase, where the trail to Ghandruk begins clearly.
            </p>

            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Trailhead Area &amp; Shops</h4>
                <p className="text-xs text-stone-500 leading-relaxed">There are no formal facilities such as luggage storage or tourism offices at the trailhead itself. A small number of local shops and tea stops are accessible near the road terminus, adequate for a cup of tea or water, but they are not reliable sources for trekking gear or snacks. Purchase these in Pokhara Lakeside first.
                </p>
              </div>
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Mobile Network &amp; Prep</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Mobile network coverage at Kimche is limited. NCell and Nepal Telecom signals can be intermittent at the trailhead but improve once you reach Ghandruk village. Carry sufficient drinking water and snacks from Pokhara to last the climb to Ghandruk.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="best-time" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Best Time of Year to Start a Trek from Kimche
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-stone-600 text-sm">
              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm">
                ...
                <p className="mt-2 text-[10px] text-stone-500 leading-relaxed">Rhododendron forests bloom in red and pink. Mornings offer excellent peak visibility, and road access is generally stable.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-sm">Autumn (Sep–Nov)</h4>
                <p className="mt-2 text-[10px] text-stone-500 leading-relaxed">Peak visibility. Post-monsoon air is clear, mountain views are sharp, and road access to Kimche is highly reliable.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm">
                <h5 className="font-bold text-stone-950 text-sm">Winter (Dec–Feb)</h5>
                <p className="mt-2 text-[10px] text-stone-500 leading-relaxed">Colder weather but very clear skies. Lower trail to Ghandruk remains open, though morning frost is common on the road.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm">
                <h5 className="font-bold text-stone-950 text-sm">Monsoon (Jun–Sep)</h5>
                <p className="mt-2 text-[10px] text-stone-500 leading-relaxed">Highest risk. Continuous rain makes the unpaved road mud-prone and landslides can temporarily block vehicle access.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="practical-tips" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Practical Tips Before Starting at Kimche
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-stone-600 text-sm">
              <div>
                ...
                <p className="mt-2 text-xs leading-relaxed text-stone-500">All trekkers must hold valid ACAP permits and TIMS cards, which must be obtained in Pokhara or Kathmandu beforehand. There is no permit office at the Kimche trailhead, and trekking without them is not allowed. Check our <Link href="/planning/acap-permit-guide" className="text-emerald-700 font-bold hover:underline">ACAP Permit Guide</Link>for details.
                </p>
              </div>

              <div>
                <h4 className="font-bold text-stone-900 text-base">Cash &amp; Porter Logistics</h4>
                <p className="mt-2 text-xs leading-relaxed text-stone-500">There are no ATMs at Kimche. Carry sufficient Nepali Rupees for your entire trek. Pack your day bag with essentials: water, snacks, rain jacket, sunscreen, and medications. Your main luggage can be transferred by a porter.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="local-guide-insights" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Local Guide Insights for Starting at Kimche
            </h2>
            <p className="text-stone-600 leading-relaxed text-sm">Our certified local guides recommend Kimche to improve the overall quality of the first day, replacing a dusty road walk with an active mountain climb.
            </p>

            <div className="bg-amber-50 border border-amber-200 p-6 rounded-2xl text-stone-600 text-sm">
              <h4 className="font-bold text-amber-950 text-base">Common Mistakes Trekkers Make</h4>
          ...
          <article id="faq" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Frequently Asked Questions About Kimche Trailhead
            </h2>
          ...
          <section id="booking" className="scroll-mt-12 bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white rounded-3xl p-8 shadow-md border border-stone-800 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 max-w-4xl">
              ...
              <p className="text-stone-300 text-sm leading-relaxed">We manage every detail of your Annapurna journey — from arranging a high-clearance jeep to Kimche and organising your ACAP permits, to booking teahouse accommodation and providing certified local guides who know every section of this trail.
              </p>
