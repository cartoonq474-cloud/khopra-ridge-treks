    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Birethanti Village & Checkpoint Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Navigating the gateway. Learn about check-in procedures, suspension bridges, and river crossings at the entry point of the Annapurna sanctuary.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Birethanti (1,025m / 3,362ft) is a bustling village situated at the confluence of the Modi Khola and Bhurungdi Khola. Located just a short drive from Nayapul, it serves as the official administrative gateway for all treks entering the western Annapurna Conservation Area.
          </p>
          <p>The village is split by the roaring rivers, connected by historic iron suspension bridges. Lined with small shops, cafes, and administrative offices, it is the place where your trekking permit will be officially inspected and stamped before you are allowed onto the trail.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Birethanti is accessible by rough dirt roads. From here, you can catch shared local jeeps heading up either to Tikhedhunga/Ulleri (on the Ghorepani side) or Syauli Bazaar/Kimche (on the Ghandruk side). Most private jeeps from Pokhara will drop off or pick up trekkers directly from their lodges here.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">We handle all ACAP and TIMS permits in advance. Our guides manage all check-in registrations at Birethanti checkpoints so you can focus on the hike.
            </p>
            <Link
              href="/#book"
