        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <div className="p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-stone-600 leading-relaxed">This Ulleri village guide is reviewed by certified local guides based in Pokhara. We regularly inspect road conditions, staircase maintenance status, and village lodge rosters to keep our details current.
              </p>
            </div>
          </div>
        </main>
