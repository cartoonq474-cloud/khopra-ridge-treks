    ...
    <div className="w-full flex-1">
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Swanta Village Lodge & Homestay Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Agricultural heritage. Discover the homestays, community cheese cooperatives, and lodge facilities in the terraced village of Swanta.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6 text-stone-600 leading-relaxed">
          ...
          <p>Swanta (2,200m / 7,217ft) is a picturesque village nestled in a sunny mountain valley. Surrounded by steep terraced crop fields growing millet, barley, and potatoes, it is primarily inhabited by the indigenous Magar community.
          </p>
          <p>For trekkers descending from the cold, wind-swept heights of Khopra Ridge, Swanta represents a warm, comfortable haven where you can enjoy hot solar showers, organic farm-to-table dining, and direct exposure to Magar culture.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-emerald-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-emerald-100/80 text-sm leading-relaxed">Book our guided trek to visit Swanta co-op cheese factory and stay in comfortable family-run homestays.
            </p>
            <Link
              href="/#book"
