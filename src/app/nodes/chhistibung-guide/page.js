      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Chhistibung is a peaceful cluster of lodges nestled in a deep forest clearing, serving as the final rest stop before the steep climb to Khopra Ridge.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 rounded-2xl border border-stone-200 bg-white p-6 sm:grid-cols-4">
            ...
            <p className="mt-1 text-sm font-bold text-stone-900">2,975 m</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Forest Type</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Sub-alpine Oak and Bamboo</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Wildlife Spotting</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Himalayan Monal, Langur Monkeys</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Trail Section</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Bayeli Kharka to Khopra Danda</p>
          </div>
