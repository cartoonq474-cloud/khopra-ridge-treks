      ...
      <div className="mx-auto max-w-4xl px-6 py-20 w-full flex-1">
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">
            Muldai Viewpoint Guide
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">
            Muldai Viewpoint (also spelled Mulde) offers a dramatic, uncrowded alternative to Poon Hill, placing you closer to Annapurna South and Dhaulagiri.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 rounded-2xl border border-stone-200 bg-white p-6 sm:grid-cols-4">
            ...
            <p className="mt-1 text-sm font-bold text-stone-900">3,637 m</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Trailhead</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Dobato (near Tadapani)</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Crowd Level</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Very low compared to Poon Hill</p>
          </div>
          <div>
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Best Time</span>
            <p className="mt-1 text-sm font-bold text-stone-900">Sunrise / Morning</p>
          </div>
