    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen font-sans antialiased flex flex-col justify-between">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white py-24 px-6 border-b border-stone-800">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/35 px-4 py-1 text-xs font-bold text-emerald-400 uppercase tracking-widest mb-6">Viewpoint Face-Off
          </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12 w-full flex-1">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-8 bg-white border border-stone-200 rounded-3xl p-6 shadow-sm space-y-4 max-h-[85vh] overflow-y-auto hidden lg:block">
            ...
            <nav className="flex flex-col gap-1 text-sm">
              <a href="#overview" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Overview &amp; Table
              </a>
              <a href="#quick-verdict" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Quick Verdict
              </a>
              <a href="#understanding" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Understanding Both
              </a>
              <a href="#mountain-views" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Himalayan Views
              </a>
              <a href="#sunrise" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Sunrise Experience
              </a>
              <a href="#panorama" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Panorama Quality
              </a>
              <a href="#photography" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Photography Comparison
              </a>
              <a href="#crowd-levels" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Crowd Levels
              </a>
              <a href="#difficulty" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Difficulty &amp; Access
              </a>
              ...
              <a href="#by-traveler" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Guides by Traveler
              </a>
              <a href="#combine" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Visit Both?
              </a>
              <a href="#sustainability" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Community Tourism
              </a>
              <a href="#final-verdict" className="px-3 py-2 rounded-xl text-stone-600 hover:text-emerald-700 hover:bg-emerald-50/50 font-bold transition duration-200 block">Final Verdict
              </a>
        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <article id="overview" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Khopra Ridge vs Poon Hill Viewpoints Comparison
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Two viewpoints dominate every conversation about mountain views in the Annapurna region: Khopra Ridge and Poon Hill. Both promise sweeping Himalayan panoramas, both sit within a few days&apos; walk of Pokhara, and both attract trekkers asking the same question — which one is actually worth my time?
            </p>
            <p className="text-stone-600 leading-relaxed text-base">The honest answer depends on what you&apos;re looking for. Poon Hill is the classic, easily reached viewpoint that has introduced generations of trekkers to the Annapurna skyline. Khopra Ridge is the quieter, higher, and more immersive alternative that brings you face to face with peaks that Poon Hill can only show you from a distance.
            </p>
            <p className="text-stone-600 leading-relaxed text-base">In this guide, we compare the two viewpoints directly — not the full treks, but the actual visual and sensory experience you get once you&apos;re standing there. We&apos;ll look at which mountains you can see, how the sunrise differs, how crowded each spot gets, what photographers should expect, and which viewpoint suits which type of traveler.
            </p>
            <p className="text-stone-600 leading-relaxed text-base">If your main goal is simply: &quot;I want the best possible mountain view in Annapurna, and I want to know which of these two spots delivers it,&quot; this guide is built to answer exactly that.
            </p>

            {/* Comparison Table */}
            <div className="bg-white border border-stone-200 rounded-3xl p-6 shadow-sm overflow-hidden mt-8">
              <h3 className="text-lg font-bold text-stone-950 mb-4 flex items-center gap-2">Quick Comparison Table
              </h3>
          ...
          <article id="quick-verdict" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Quick Verdict for Different Travelers
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">If you only read one section, read this one:
            </p>
          ...
          <article id="understanding" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Understanding the Two Viewpoints
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">To understand why these two viewpoints feel so different, it helps to know where each one sits within the Annapurna trekking network and what kind of experience it was originally known for.
            </p>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-stone-900">What Makes Khopra Ridge Viewpoint Unique?</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Khopra Ridge sits at roughly 3,660 meters, perched along a long, open ridgeline in the upper reaches of the Annapurna Conservation Area. Unlike many viewpoints that are a single hilltop you climb for an hour and descend from, Khopra Ridge is a destination in its own right — a place where you spend a night, wake up at altitude, and step outside directly into the view.
                </p>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">The ridge faces Dhaulagiri and Annapurna South almost head-on, with no major foothills blocking the line of sight. This positioning is what gives Khopra its reputation for &quot;face-to-face&quot; mountain views rather than a distant skyline.
                </p>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Accommodation along the route is built around a community lodge system, primarily supporting local Magar villages such as Swanta and Bayeli Kharka. For trekkers who want the option to go even higher, Khopra Ridge connects to Khayer Lake, a sacred high-altitude lake at around 4,660 meters that adds an extra day but pushes the views into genuinely alpine territory.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-stone-900">What Makes Poon Hill Viewpoint Unique?</h3>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Poon Hill, at 3,210 meters, is the most visited viewpoint in the Annapurna region and arguably one of the most photographed sunrise spots in Nepal. It sits just above the village of Ghorepani, reached via a short, steep climb of stone steps that takes most trekkers 45 minutes to just over an hour.
                </p>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">What made Poon Hill famous is its accessibility combined with its panorama. From the summit, you get a wide horizontal sweep of the Annapurna range, including Annapurna I, Annapurna South, Hiunchuli, Dhaulagiri, Nilgiri, and on clear mornings, Machapuchare&apos;s distinctive fishtail peak.
                </p>
                <p className="text-stone-600 leading-relaxed text-sm mt-2">Because it can be reached as part of a 3–4 day trek from Pokhara, Poon Hill has become the default &quot;first Himalayan viewpoint&quot; for an enormous number of travelers. That accessibility is precisely why it draws such large crowds at sunrise — sometimes several hundred people standing shoulder to shoulder on the summit platform during peak season.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="mountain-views" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Mountain Views Comparison: Which Viewpoint Has Better Himalayan Scenery?
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">This is the section that matters most for choosing based on visual impact. The two viewpoints don&apos;t just show you different amounts of the same mountains — they show you the mountains from genuinely different angles and distances.
            </p>

            <div className="space-y-6">
              <div>
                <h4 className="font-bold text-stone-900 text-lg">Dhaulagiri Views from Khopra Ridge vs Poon Hill</h4>
                <p className="text-xs text-stone-600 leading-relaxed mt-1">From Poon Hill, Dhaulagiri appears as part of the wider horizon — a massive, unmistakable presence, but one among several major peaks sharing your field of view. It&apos;s impressive, but it reads as a backdrop.
                </p>
                <p className="text-xs text-stone-600 leading-relaxed mt-2 font-medium">From Khopra Ridge, Dhaulagiri dominates. The ridge sits close enough that the mountain&apos;s scale becomes genuinely difficult to process — you&apos;re not looking at a horizon feature anymore, you&apos;re looking at a wall of ice and rock that fills a huge portion of your view. Many trekkers describe this as the single biggest visual difference between the two viewpoints.
                </p>
              </div>

              <div>
                <h4 className="font-bold text-stone-900 text-lg">Annapurna South Views from Both Viewpoints</h4>
                <p className="text-xs text-stone-600 leading-relaxed mt-1">Annapurna South is visible from both locations, but again the difference is proximity. Poon Hill offers a clean, well-framed view of the peak as part of the broader Annapurna massif — elegant, but at a distance.
                </p>
                <p className="text-xs text-stone-600 leading-relaxed mt-2 font-medium">Khopra Ridge places you considerably closer, with Annapurna South appearing sharper, larger, and more three-dimensional. On clear mornings, you can pick out ridgelines, snow fields, and rock faces that simply aren&apos;t visible from Poon Hill&apos;s distance.
                </p>
              </div>

              <div>
                <h4 className="font-bold text-stone-900 text-lg">Machapuchare, Nilgiri, and Tukuche Peak Visibility</h4>
                <p className="text-xs text-stone-600 leading-relaxed mt-1">Machapuchare (Fishtail) is visible from Poon Hill on clear days, appearing as a sharp, recognizable spike toward the eastern side of the panorama. It&apos;s one of the most-photographed elements of the Poon Hill view precisely because of its distinctive shape.
                </p>
                <p className="text-xs text-stone-600 leading-relaxed mt-2">From Khopra Ridge, Machapuchare is visible from certain points along the ridge, though it sits further away. Nilgiri and Tukuche Peak, on the other hand, are better appreciated from the Khopra side, where their positioning along the Kali Gandaki valley becomes more apparent. Poon Hill includes both in its wider sweep, but as smaller elements within a busier skyline.
                </p>
              </div>
          ...
          <article id="sunrise" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Sunrise Experience Comparison
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Sunrise is the reason most people climb to either viewpoint in the first place, and it&apos;s also where the two experiences diverge most sharply — not in terms of the light itself, but in terms of how you experience it.
            </p>

            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Sunrise at Poon Hill</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Sunrise at Poon Hill is, by design, a shared event. Trekkers begin climbing in the dark, often in long lines of headlamps snaking up the stone steps from Ghorepani. By the time the sky starts to lighten, the summit platform and surrounding viewpoints fill with anywhere from 300 to 500+ people during high season.
                </p>
                <p className="text-xs text-stone-500 leading-relaxed">The sunrise sequence itself is genuinely beautiful — the first light striking Dhaulagiri and the Annapurna range, the colors shifting from pink to gold across the panorama. But the atmosphere is unmistakably communal: cameras everywhere, conversations in a dozen languages, and a real logistical challenge in finding a clear spot to stand.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm space-y-2">
                <h4 className="font-bold text-stone-950 text-base">Sunrise at Khopra Ridge</h4>
                <p className="text-xs text-stone-500 leading-relaxed">Sunrise at Khopra Ridge is a fundamentally different experience. Because you&apos;re already sleeping at altitude on the ridge itself, there&apos;s no pre-dawn climb — you step outside your lodge and the view is simply there.
                </p>
                <p className="text-xs text-stone-500 leading-relaxed">The number of people sharing this moment with you is typically in the single digits, sometimes zero. The ridge&apos;s open, elevated position means the first light hits Dhaulagiri and Annapurna South with a clarity that feels almost private. There&apos;s space to move, to find your own composition, and to simply stand and watch in absolute silence.
                </p>
              </div>
            </div>
          ...
          <article id="panorama" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Panorama Quality and Overall Scenic Experience
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Beyond individual mountains and sunrise moments, there&apos;s a broader question of how each viewpoint feels as a complete visual experience.
            </p>
          ...
          <article id="photography" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Photography Comparison
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                ...
                <p className="text-xs text-stone-500 leading-relaxed mt-2">Khopra Ridge has a clear practical advantage. Its remoteness means minimal light pollution, making it exceptionally suitable for night sky and Milky Way photography. Poon Hill sits closer to the lit-up teahouses of Ghorepani and sees far more headlamp activity during pre-dawn hours.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="crowd-levels" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Crowd Levels and Atmosphere
            </h2>
          ...
          <article id="difficulty" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Trek Difficulty and Accessibility
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">The view you get is directly tied to the effort required to reach it — and this is often the deciding factor for travelers with limited time or fitness concerns.
            </p>

            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Reaching Poon Hill</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">Poon Hill is reached via a well-established route through Ghorepani, typically as part of a 3–4 day loop from Pokhara. The final climb to the viewpoint itself is a steep but short ascent on stone steps, taking most trekkers 45 minutes to an hour. Trail infrastructure makes this one of the most beginner-friendly viewpoint treks in Nepal.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Reaching Khopra Ridge</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">Reaching Khopra Ridge requires considerably more commitment — typically 4–5 days of trekking from access points like Ghandruk or Swanta, with sustained, steady climbing on less-developed trails. The altitude gain is significant, and trekkers should be comfortable with multiple consecutive days of uphill walking at elevation.
                </p>
              </div>
            </div>
          ...
          <article id="best-time" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Best Time to Visit Khopra Ridge and Poon Hill
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Visibility at both viewpoints changes significantly with the seasons, and timing your visit correctly matters more than almost any other factor in determining whether you&apos;ll actually see the mountains.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Autumn is widely considered the best season. Skies are typically clear, humidity is low, and visibility is consistently strong. This is also the busiest season at Poon Hill, so expect crowds to peak alongside the clear views.
                </p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Spring brings rhododendron forests blooming in vivid reds and pinks along the lower trail sections. Mountain visibility is generally good but can be variable, with occasional haze building later in the day.
                </p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Winter offers some of the clearest air of the year, producing crisp, high-contrast mountain views. The trade-off is cold temperatures, particularly at Khopra Ridge, and potential snow. Crowds drop significantly.
                </p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-5 rounded-2xl">
                ...
                <p className="text-[11px] text-stone-500 leading-relaxed mt-2">Monsoon season is the most challenging time for visibility. Cloud cover frequently obscures the peaks, and rain can make trails slippery. Early morning windows occasionally offer brief clear views.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="by-traveler" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Which Viewpoint Is Better for Different Types of Travelers?
            </h2>
          ...
          <article id="combine" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Can You Visit Both Khopra Ridge and Poon Hill on the Same Trek?
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">For travelers with enough time, combining both viewpoints is not only possible but offers a genuinely complementary experience — the wide panorama of Poon Hill alongside the close-up immersion of Khopra Ridge.
            </p>

            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Combined Route (9-11 Days)</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">Routes linking the two viewpoints typically extend an itinerary to around 9–11 days, often passing through Ghorepani and Tadapani before continuing toward the Khopra ridge system via Chhistibung. This adds trekking days and elevation gain, but allows travelers to experience both perspectives within a single trip.
                </p>
              </div>

              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm">
                <h4 className="font-bold text-stone-950 text-base">Who Should Consider This?</h4>
                <p className="text-xs text-stone-500 leading-relaxed mt-2">This combined approach makes the most sense for photography-focused travelers who want both the wide establishing shots Poon Hill offers and the intimate details Khopra Ridge enables, as well as for trekkers who want to experience the full range of what the Annapurna foothills offer.
                </p>
              </div>
            </div>
          </article>
          ...
          <article id="sustainability" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Community Tourism and Sustainability Differences
            </h2>
            <p className="text-stone-600 leading-relaxed text-base">Beyond the views themselves, there&apos;s a meaningful difference in how each route supports the communities along the way.
            </p>
          ...
          <article id="final-verdict" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Final Verdict: Khopra Ridge vs Poon Hill Views
            </h2>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-stone-100 p-6 rounded-2xl border border-stone-200">
                ...
                <p className="text-xs text-stone-600 leading-relaxed mt-2">You have limited time — typically 3–4 days available from Pokhara — and want a reliable, well-supported introduction to Himalayan views. It&apos;s also the better choice if you&apos;re traveling with family members or companions who prefer a shorter, gentler climb, or if a wide panoramic sweep of the Annapurna range matters more to you than proximity.
                </p>
              </div>

              <div className="bg-stone-100 p-6 rounded-2xl border border-stone-200">
                <h4 className="font-bold text-stone-950 text-base">Choose Khopra Ridge If...</h4>
                <p className="text-xs text-stone-600 leading-relaxed mt-2">You have 9–10 days available and are looking for a quieter, more immersive mountain experience. It&apos;s the stronger choice if close-up views of Dhaulagiri and Annapurna South are a priority, if you want meaningfully fewer crowds at sunrise, or if landscape and astrophotography are significant parts of why you&apos;re trekking.
                </p>
              </div>
            </div>
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 mt-6">
              ...
              <p className="mt-2 text-xs text-emerald-800 leading-relaxed">If your core question is genuinely &quot;which viewpoint gives me the better mountain-view experience,&quot; Khopra Ridge is the stronger answer for most travelers who can spare the extra days. The combination of proximity to major peaks, near-total solitude at sunrise, and a community tourism model that channels your trekking spend directly into local villages gives it an edge that&apos;s difficult for Poon Hill to match on visual terms alone.
              </p>
              <p className="mt-2 text-xs text-emerald-800 leading-relaxed">That said, Poon Hill earns its reputation honestly. For travelers with tighter schedules, lower fitness levels, or families in tow, it remains a beautiful and rewarding viewpoint — just one experienced very differently, and very much in the company of others.
              </p>
            </div>
          </article>
          ...
          <article id="faq" className="scroll-mt-12 space-y-6">
            <h2 className="text-3xl font-extrabold text-stone-950 tracking-tight border-b border-stone-200 pb-3">Frequently Asked Questions About Khopra Ridge vs Poon Hill Views
            </h2>
          ...
          <article className="space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-sm">Khopra Ridge and Poon Hill aren&apos;t competing for the same title — they&apos;re answering different questions about what a mountain view should feel like. Poon Hill gives you breadth: a wide, classic sweep of the Annapurna range, reached quickly and shared with fellow travelers from around the world. Khopra Ridge gives you depth: fewer peaks, but seen up close, often in near-total silence, with the added benefit of supporting community-owned lodges along the way.
            </p>
            <p className="text-stone-600 leading-relaxed text-sm">If you&apos;re weighing this decision against your own itinerary, fitness level, and priorities, the comparisons above should give you a clear sense of which experience fits. And if you&apos;re still not sure which one — or whether combining both — makes sense for your trip, our local trekking specialists are happy to help you work it out.
            </p>
          </article>
          ...
          <section id="booking" className="scroll-mt-12 bg-gradient-to-br from-stone-900 via-stone-850 to-emerald-950 text-white rounded-3xl p-8 shadow-md border border-stone-800 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 max-w-4xl">
              ...
              <p className="text-stone-300 text-sm leading-relaxed">Let our local trek planners design an itinerary around your fitness level, available days, and what you most want to see — whether that&apos;s the wide Poon Hill panorama, the close-up views from Khopra Ridge, or both combined.
              </p>
