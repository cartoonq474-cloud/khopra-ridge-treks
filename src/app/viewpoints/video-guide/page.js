    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen flex flex-col justify-between antialiased">
      <main className="mx-auto max-w-4xl px-6 py-20 flex-1">
        ...
        <div className="border-b border-stone-200 pb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-stone-950 sm:text-5xl leading-tight">Khopra Ridge Video Walkthroughs
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed font-medium">Explore the trails in motion. A curated directory of drone compilations, first-person trail walkthroughs, and safety briefings.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-6">
          ...
          <p className="text-stone-600 leading-relaxed">Videos offer a dynamic perspective of trail conditions, river crossings, and lodge facilities. To prepare you for the physical layout and altitude changes, watch our curated walkthrough videos of the Khopra circuit.
          </p>
        </div>
            ...
            {videoGuides.map((vid, idx) => (
              <div key={idx} className="p-6 bg-white border border-stone-200 rounded-3xl shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-stone-100 pb-3 gap-2">
                  ...
                  <span className="text-xs font-bold text-emerald-600 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 shrink-0">Duration: {vid.duration}
                  </span>
                </div>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-stone-600 leading-relaxed">Our guides review all video footage to verify trail accuracy, landslide landmarks, and safety markers.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-stone-950 p-8 text-white border border-white/5 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-lg">Explore these traditional villages with our licensed local guides. Secure your permit-inclusive booking packages with our local team.
            </p>
...
export const metadata = {
  alternates: {
    canonical: '/viewpoints/video-guide',
  },
};
